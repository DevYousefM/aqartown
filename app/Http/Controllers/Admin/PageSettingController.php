...
class PageSettingController extends Controller
{
    ...
    protected $rules =
    [
        'best_seller_banner' => 'mimes:jpeg,webp,jpg,png,svg',
        'big_save_banner'    => 'mimes:jpeg,webp,jpg,png,svg',
        'best_seller_banner1' => 'mimes:jpeg,webp,jpg,png,svg',
        'big_save_banner1'    => 'mimes:jpeg,webp,jpg,png,svg'
    ];
