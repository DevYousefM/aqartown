        ...
        <div class="col-lg-6 col-md-6 product-single-gallery">
                ...
                <div class="product-single-carousel owl-carousel owl-theme">
                    <div class="product-item">
                        <img class="product-single-image"
                            ...
                            data-zoom-image="{{ filter_var($product->photo, FILTER_VALIDATE_URL) ? $product->photo : asset(access_public() . 'assets/images/products/' . $product->photo) }}"
                            @if (!$slang) @if ($lang->id == 2)
                                                               
                                                              alt="{{ $product->alt_ar }}"        
                                                              @else 
                                                               alt="{{ $product->alt }}" @endif
                        @else
                            @if ($slang == 2) alt="{{ $product->alt_ar }}"    
                                                              @else
                                                                   alt="{{ $product->alt }}" @endif
                            @endif
                        />
                    ...
                    @foreach ($product->galleries as $gal)
                        <div class="product-item">
                            <img class="product-single-image"
                                ...
                                data-zoom-image="{{ asset(access_public() . 'assets/images/galleries/' . $gal->photo) }}"
                                @if (!$slang) @if ($lang->id == 2)
            ...
            <div class="prod-thumbnail row owl-dots" id='carousel-custom-dots'>
                <div class="col-3 owl-dot">
                    <img src="{{ filter_var($product->photo, FILTER_VALIDATE_URL) ? $product->photo : asset(access_public() . 'assets/images/products/' . $product->photo) }}"
                        style="height:100px;"
                        @if (!$slang) @if ($lang->id == 2)
                ...
                @foreach ($product->galleries as $gal)
                    <div class="col-3 owl-dot">
                        <img src="{{ asset(access_public() . 'assets/images/galleries/' . $gal->photo) }}"
                            style="height:100px;" />
                    </div>
                @endforeach
            </div>
            ...
            <div class="product-single-details">
                ...
                <div class="ratings-container">
                    <div class="product-ratings">
                        <span class="ratings"
                            style="{{ App\Models\Rating::ratings($product->id) }}%"></span><!-- End .ratings -->
