...
@if ($payment == 'stripe')
    ...
    <div class="row">
        <div class="col-lg-6">
            <input class="form-control card-elements" name="cardNumber" type="text"
                placeholder="{{ $langg->lang163 }}" autocomplete="off" autofocus oninput="validateCard(this.value);" />
    ...
    <script type="text/javascript" src="{{ asset(access_public() . 'assets/front/js/payvalid.js') }}"></script>
    <script type="text/javascript" src="{{ asset(access_public() . 'assets/front/js/paymin.js') }}"></script>
    <script type="text/javascript" src="https://js.stripe.com/v2/"></script>
    <script type="text/javascript" src="{{ asset(access_public() . 'assets/front/js/payform.js') }}"></script>
