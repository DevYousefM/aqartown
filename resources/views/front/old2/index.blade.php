...
@section('content')
    ...
    <section>
        <div class="w-100 pt-100 gray-layer opc95 pb-100 position-relative">
            <div class="fixed-bg"
                style="background-image: url({{ asset(access_public() . 'assets/images/' . $gs->about_background) }});">
            </div>
            <div class="container">
                                ...
                                <div class="row align-items-end mrg20">
                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                        <div class="about-gal-img brd-rd10 overflow-hidden position-relative w-100">
                                            <a href="{{ asset(access_public() . 'assets/images/' . $gs->home_about_img1) }}"
                                                data-fancybox="gallery" title=""><img class="img-fluid w-100"
                                                    src="{{ asset(access_public() . 'assets/images/' . $gs->home_about_img1) }}"
                                                    alt="About Gallery Image 1"></a>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                        <div class="about-gal-img brd-rd10 overflow-hidden position-relative w-100">
                                            <a href="{{ asset(access_public() . 'assets/images/' . $gs->home_about_img2) }}"
                                                data-fancybox="gallery" title=""><img class="img-fluid w-100"
                                ...
                                <div class="row mrg20">
                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                        <div
                                            ...
                                            <a href="{{ asset(access_public() . 'assets/images/' . $gs->home_about_img3) }}"
                                                data-fancybox="gallery" title=""><img class="img-fluid w-100"
                                                    src="{{ asset(access_public() . 'assets/images/' . $gs->home_about_img3) }}"
                                    ...
                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                        <div class="about-gal-img brd-rd10 overflow-hidden position-relative w-100">
                                            <a class="about-play-btn spinner thm-clr rounded-circle"
                                                href="{{ asset(access_public() . 'assets/images/' . $gs->home_about_link) }}"
    ...
    <section>
        <div class="w-100 pt-200 white-layer opc95 pb-100 position-relative">
            <div class="fixed-bg"
                style="background-image: url({{ asset(access_public() . 'assets/images/' . $gs->service_background) }});">
            </div>
            <div class="container">
                <div
