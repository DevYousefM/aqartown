            ...
            <div class="gallery-layout">
                <div class="home-light-gallery">
                    @foreach ($images as $key => $data)
                        <a href="{{ asset(access_public() . 'assets/images/gallery/' . $data->photo) }}" data-aos="zoom-in"
                            data-aos-duration="1500">
                            <img src="{{ asset(access_public() . 'assets/images/gallery/' . $data->photo) }}"
                        ...
                        <div class="row align-items-center regervation_content">
                            <div class="col-lg-7">
                                <div class="appointment-right">
                                    ...
                                    <textarea name="messege" class="" rows="5" placeholder="اترك رسالة" onfocus="this.placeholder = ''"
                                        onblur="this.placeholder = 'اترك رساله'"></textarea>
...
@section('js')
    <script src="{{ asset(access_public() . 'assets/Al-Araby/js/lightgallery.js') }}"></script>
    <script>
