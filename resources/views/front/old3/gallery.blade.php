...
@section('css')
    <link rel="stylesheet" href="{{ asset(access_public() . 'assets/smilehouse/css/lightgallery.css"') }}">
@stop
                ...
                <div class="row">
                    ...
                    @foreach ($images as $key => $data)
                        <div class="col-md-4 mix a{{ $data->country_id }}">
                            <a href="{{ asset(access_public() . 'assets/images/gallery/' . $data->photo) }}"
                                class="img_popup single_gallery ">
                                <div class="gallery_img"
                                    style="background-image: url({{ asset(access_public() . 'assets/images/gallery/' . $data->photo) }});">
