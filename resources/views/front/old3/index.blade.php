            ...
            <div class="swiper-wrapper">
                ...
                @foreach ($sliders as $slide)
                    ...
                    <div class="swiper-slide slide">
                        <img src="{{ asset('/' . access_public() . '/assets/images/sliders/' . $galss) }}" alt="">
                        ...
                        <div class="auto-container">
                            <div class="content">
                                ...
                                @if (!empty($slide->btn_text) || !empty($slide->btn_text_ar))
                                    <div class="btn-box">
                                        <a href="{{ $slide->link }}" class="theme-btn btn-style-two"><span
                                                class="txt">{{ $langg->rtl == 1 ? $slide->btn_text_ar : $slide->btn_text }}</span></a>
                                    </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="owl-carousel owl-theme image-column">
                        ...
                        @foreach ($images as $image)
                            <div class="image item">
                                <img src="{{ asset('/' . access_public() . '/assets/images/ads/' . $image->photo) }}"
                                    alt="">
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="column col-lg-6 col-md-6 col-sm-12">
                        <ul class="list-style-one">
                            @foreach ($chunk as $serv)
                                <li><img src="{{ asset('/' . access_public() . '/assets/images/gallery/' . $serv->photo) }}"
                    ...
                    @foreach ($services as $service)
                        <a href="{{ asset(access_public() . 'assets/images/services/' . $service->photo) }}"
                            ...
                            <div class="gallery_img"
                                style="background-image: url({{ asset(access_public() . 'assets/images/services/' . $service->photo) }});">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label><span class="icon flaticon-doctor"></span>
                                                    {{ $langg->lang37 }}</label>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label><span class="icon flaticon-phone-receiver"></span>
                                                    {{ $langg->lang47 }}</label>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <label><span class="icon flaticon-envelope"></span>
                                                    {{ $langg->lang49 }}</label>
