                    ...
                    <div class="col-lg-6">
                        <div class="faq__BlockImage overflow-hidden position-relative" data-aos="fade">
                            ...
                            <img class="faq__image b-lazy"
                                data-src="{{ asset(access_public() . 'assets/images/' . $gs->new_icon) }}"
                                src="{{ asset(access_public() . 'assets/images/' . $gs->new_icon) }}" alt="">
                        </div>
...
padding-right: 35px;">
            ...
            <img class="faq__illustration position-absolute"
                src="{{ asset(access_public() . 'assets/cangrow/images/svg/faq-illustration.svg') }}"
                ...
                <div class="col-md-6">
                    <div class="subscribe__BlockImage overflow-hidden position-relative" data-aos="fade"
                        ...
                        <img class="subscribe__image position-absolute b-lazy"
                            data-src="{{ asset(access_public() . 'assets/images/' . $gs->trending_icon) }}"
                            src="{{ asset(access_public() . 'assets/images/' . $gs->trending_icon) }}" alt="">
                    </div>
                </div>
