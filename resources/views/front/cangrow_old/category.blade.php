...
@section('content')
    ...
    <main class="main page page__service">
        <div class="page__header container">
            <div class="row">
                <div class="col-12">
                    <h1 class="page__title text-center text-uppercase" data-aos="fade-up">
                        @if (!empty($childcat))
                            @if ($langg->rtl == 1)
                                {{ $childcat->name_ar }}
                            @else
        ...
        <div class="wrap-header-illustration" data-aos="fade" data-aos-delay="500">
            <h2 class="page-title-above-illustration text-center">
                @if (!empty($childcat))
                    @if ($langg->rtl == 1)
                        {{ $childcat->name_ar }}
                    @else
            ...
            <div class="col-12">
                <div class="w-100 pt-180 pb-180 page-title-wrap text-center black-layer opc5 position-relative">
                    <img src="{{ asset(access_public() . 'assets/images/' . $gs->top_icon) }}" alt="{{ $langg->lang16 }}">
                        ...
                        <div class="col-12 col-md-6 col-xl-4" data-aos="fade-up" data-aos-delay="{{ $key + 1 }}00">
                            <div class="pageService__item">
                                <div class="pageService__wrap-illustration">
                                    <img src="{{ $productt->photo ? (filter_var($productt->photo, FILTER_VALIDATE_URL) ? $productt->photo : asset(access_public() . 'assets/images/products/' . $productt->photo)) : asset(access_public() . 'assets/images/noimage.png') }}"
                                        alt="Planning">
                                </div>
