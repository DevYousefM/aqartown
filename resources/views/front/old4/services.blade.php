    ...
    <div class="page-wrapper">
        ...
        <section class="page-breadcrumb">
            <div class="image-layer"
                style="background-image:url({{ asset(access_public() . 'assets/naglaa/images/background/1.png') }})">
            </div>
            <div class="container">
                <div class="clearfix">
                        ...
                        <div class="department-box">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3><i class="fad fa-syringe"></i><a href="services-detail.html">فيلر
                                            الشفايف</a><i class="fad fa-syringe"></i></h3>
