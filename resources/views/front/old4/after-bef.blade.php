                    ...
                    data-aos="fade-right" @endif>
                        <div class="twentytwenty-wrapper twentytwenty-horizontal">
                            <div class="twentytwenty-container" id="container1" style="height: 300px;">
                                ...
                                <img src="{{ asset(access_public() . 'assets/images/ads/' . $data->photo) }}"
                                    class="img-fluid w-100 twentytwenty-before" alt=""
                                    style="clip: rect(0px, 196.5px, 300px, 0px);">
                                <img src="{{ asset(access_public() . 'assets/images/ads/' . $data->image) }}"
...
@stop
@section('js')
    <script src="{{ asset(access_public() . 'assets/naglaa/assets/js/jquery.event.move.js') }}"></script>
    <script src="{{ asset(access_public() . 'assets/naglaa/assets/js/jquery.twentytwenty.js') }}"></script>
    <script>
