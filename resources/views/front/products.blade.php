                                ...
                                <div class="min-pro-box">
                                    ...
                                    <div class="min-box-t">
                                        ...
                                        <ul class="min-f-img">
                                            {{--
                                                <li>
                                                    <img src="{{ asset(access_public() . 'assets/aqar/') }}/images/b-o.png" alt=""> 3 Br
                                                </li>
                                                <li>
                                                    <img src="{{ asset(access_public() . 'assets/aqar/') }}/images/ba-o.png" alt=""> 3 Ba
                                                </li>
                                                <li>
                                                    <img src="{{ asset(access_public() . 'assets/aqar/') }}/images/g-o.png" alt=""> 1 Gr
                                                </li>
                                            --}}
