                ...
                @foreach ($sliders as $k => $slide)
                    ...
                    <div class="swiper-slide">
                        <div class="slide-bg-img"
                            data-background="{{ asset('/' . access_public() . '/assets/images/sliders/' . $galss) }}">
                ...
                @foreach ($categories as $cat)
                    <div class="col-12 col-md-9  col-lg-4 mx-auto service-card">
                        <div class="flip-card flip-x wow fadeInUp " data-wow-offset="0" data-wow-delay=".2s">
                            ...
                            {{--    {{asset(access_public() . 'assets/images/categories/'.$cat->photo)}} --}}
                            <div class="back-face">
                                    ...
                                    <div class="testmonial-card d-flex align-items-center justify-content-center">
                                        <div class="testimonial-content">
                                            <div class="customer-info "><img class="img-fluid "
                                                    src="{{ $review->photo ? asset(access_public() . 'assets/images/reviews/' . $review->photo) : asset(access_public() . 'assets/images/noimage.png') }}"
                                                    alt="First Slide ">
