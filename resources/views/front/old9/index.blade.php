                ...
                <div class="col-md-6">
                    ...
                    <form action="#" method="post" id="bmi-form" class="" onsubmit="return false">
                        ...
                        <div class="formBtn flex-start">
                            <button type="button" class="btn primary-btn submit-btn" data-toggle="modal"
                                data-target="#exampleModal" onclick="getbmivalue()">
                                احسب
                            </button>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="formGroup required">
                                                ...
                                                <input type="text" step="1" min="2" class="formControl"
                                                    name="age" id="bmivalue" readonly>
                                            </div>
                                        </div>
