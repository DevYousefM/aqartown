...
@section('content')
    ...
    <div class="page-title"
        style="background:linear-gradient(#21459799, #21459799), url({{ asset(access_public() . 'assets/images/' . $gs->big_icon) }});"
        data-overlay="5">
        <div class="container">
            <div class="row">
    ...
    <section class="section-padding bg-light-white blog-details" style="padding: 80px 0;">
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    <img style="width: 100%;"
                        src="{{ asset(access_public() . 'assets/images/products/' . $solution->hover_photo) }}"
                        alt="">
                </div>
