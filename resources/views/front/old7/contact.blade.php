...
@section('content')
    ...
    <div class="page-title"
        style="background:linear-gradient(#21459799, #21459799), url({{ asset(access_public() . 'assets/images/' . $gs->discount_icon) }});"
        data-overlay="5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="breadcrumbs-wrap">
                        ...
                        <h2 class="breadcrumb-title">{{ $langg->lang220 }} -<span
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="property_block_wrap">
                        ...
                        <form action="{{ route('front.contact.submit') }}" name="appointment" id="email-form"
                            method="POST" autocomplete="off" class="contact_form2">
                            {{ csrf_field() }}
