                    ...
                    <section class="Grid">
                        <div class=" Grid-row">
                            @foreach ($cats as $data)
                                <a class="Card fltr-itm{{ $data->country_id }} fltr-itm"
                                    onClick="openGallery({{ $data->id }})" id="card-{{ $data->id }}">
                                    <div class="Card-thumb">
                                        <div class="Card-shadow"></div>
                                        <div class="Card-shadow"></div>
                                        <div class="Card-shadow"></div>
                                        <div class="Card-image"
                                            style="background-image: url({{ $data->photo ? asset('assets/images/gallery/' . $data->photo) : asset('assets/images/noimage.png') }});background-size: 100%;">
                                        </div>
                                    </div>
                                    <div class="Card-title"><span>Super interesting card</span></div>
                                    <div class="Card-explore"><span>Explore 50 more</span></div><button
                                        class="Card-button">{{ $data->name }}</button>
                                </a>
                            @endforeach
