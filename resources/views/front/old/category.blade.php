...
@section('content')
    ...
    <section>
        <div class="w-100 pt-180 pb-180 page-title-wrap text-center black-layer opc5 position-relative">
            <div class="fixed-bg"
                style="background-image: url({{ asset(access_public() . 'assets/images/' . $gs->big_icon) }});"></div>
            <div class="container">
                                ...
                                <div class="event-grid-box mb-30 w-100">
                                    <div class="event-grid-img w-100 overflow-hidden position-relative">
                                        <img class="img-fluid w-100"
                                            src="{{ $productt->photo ? (filter_var($productt->photo, FILTER_VALIDATE_URL) ? $productt->photo : asset(access_public() . 'assets/images/products/' . $productt->photo)) : asset(access_public() . 'assets/images/noimage.png') }}"
                                            alt="Event Image 1">
