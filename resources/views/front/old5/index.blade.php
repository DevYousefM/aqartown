    ...
    <section class="section_padding about_us_area" data-scroll-index="1">
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="about_bg"
                        style="background-image: url({{ asset(access_public() . 'assets/images/' . $gs->home_about_img1) }});">
                    </div>
                </div>
            </div>
        </div>
                ...
                @foreach ($categories->take(8) as $key => $category)
                    <div class="col-lg-3  p-0">
                        <a
                            ...
                            <div
                                class="boxmoth boxmoth-1"style="background-image: url({{ asset(access_public() . 'assets/images/categories/' . $category->photo) }});">
                                <h6>0{{ $key + 1 }}.</h6>
                                <h5>
                                    @if ($langg->rtl == 1)
                                        {{ $category->name_ar }}
                ...
                @foreach ($our_teams->take(5) as $data)
                    <div class="col-lg-3">
                        <div class="card carda">
                            <img src="{{ asset(access_public() . 'assets/images/speakers/' . $data->photo) }}"
                                alt="">
                            <ul class="links">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <img width="450" height="450"
                                ...
                                srcset="{{ asset(access_public() . 'assets/images/reviews/' . $review->photo) }} 450w, {{ asset(access_public() . 'assets/images/reviews/' . $review->photo) }} 300w, {{ asset(access_public() . 'assets/images/reviews/' . $review->photo) }} 150w, {{ asset(access_public() . 'assets/images/reviews/' . $review->photo) }} 400w"
                ...
                <div class="col-md-8">
                    <div class="clints-slider owl-carousel owl-theme">
                        @foreach ($partners as $partner)
                            <div class="item">
                                <img src="{{ asset(access_public() . 'assets/images/partner/' . $partner->photo) }}"
                                    alt="">
                            </div>
                        @endforeach
                    </div>
