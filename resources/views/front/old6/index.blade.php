            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <img src="{{ asset(access_public() . 'assets/images/' . $gs->popup_background) }}" alt="">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="flip-right" data-aos-duration="1500">
                        <div class="single-features">
                            <div class="content">
                                ...
                                <a class="readmore_btn"
                                    href="{{ route('front.service', ['service' => $service->title, 'lang' => $sign]) }}">{{ $langg->lang49 }}<i
