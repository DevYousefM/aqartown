                 ...
                 <div class="footer-info-area">
                     <div class="footer-logo">
                         <a href="{{ route('front.index', $sign) }}" class="logo-link">
                             <img src="{{ asset(access_public() . 'assets/images/' . $gs->footer_logo) }}"
                                 alt="">
                         </a>
                     </div>
                     <div class="text">
     ...
     <div class="modal-dialog quickview-modal modal-dialog-centered modal-lg" role="document">
         <div class="modal-content">
             <div class="submit-loader">
                 <img src="{{ asset(access_public() . 'assets/images/' . $gs->loader) }}" alt="">
             </div>
             <div class="modal-header">
                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                     <span aria-hidden="true">&times;</span>
...
?>
 ...
 <!-- jquery -->
 <script src="{{ asset(access_public() . 'assets/front/js/jquery.js') }}"></script>
 {{-- <script src="{{asset(access_public() . 'assets/front/js/vue.js')}}"></script> --}}
 <script src="{{ asset(access_public() . 'assets/front/jquery-ui/jquery-ui.min.js') }}"></script>
 <!-- popper -->
 <script src="{{ asset(access_public() . 'assets/front/js/popper.min.js') }}"></script>
 <!-- bootstrap -->
 <script src="{{ asset(access_public() . 'assets/front/js/bootstrap.min.js') }}"></script>
 <!-- plugin js-->
 <script src="{{ asset(access_public() . 'assets/front/js/plugin.js') }}"></script>

 <script src="{{ asset(access_public() . 'assets/front/js/xzoom.min.js') }}"></script>
 <script src="{{ asset(access_public() . 'assets/front/js/jquery.hammer.min.js') }}"></script>
 <script src="{{ asset(access_public() . 'assets/front/js/setup.js') }}"></script>

 <script src="{{ asset(access_public() . 'assets/front/js/toastr.js') }}"></script>
 <!-- main -->
 <script src="{{ asset(access_public() . 'assets/front/js/main.js') }}"></script>
 <!-- custom -->
 <script src="{{ asset(access_public() . 'assets/front/js/custom.js') }}"></script>
