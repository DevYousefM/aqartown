...
<head>
    ...
    <script type="application/ld+json">
  {
    ...
    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/all.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/owl.carousel.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/owl.theme.default.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/bootstrap.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/linearicons.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/ionicons.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/fontello.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/featherIcons.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/swiper.min.css') }}" />
    <!-- <link rel="stylesheet" href="./css/slick.css" /> -->
    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/slick.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/lineaer-icons.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/nice-select.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/jquery.fancybox.min.css') }}">

    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/fotorama.css') }}" />


    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/lightgallery.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/aos.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/hamburgers.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/almaclinic/css/index.css') }}" />
...
-->
   ...
   @if ($langg->rtl == 1)
    ...
    <script src="{{ asset('assets/almaclinic/js/jquery-3.4.1.min.js') }}"></script>
    <script src="{{ asset('assets/almaclinic/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('assets/almaclinic/js/aos.js') }}"></script>
    <script src="{{ asset('assets/almaclinic/') }}/js/popper.min.js"></script>
    <!-- <script src="./js/jquery.counterup.js"></script> -->
    <script src="{{ asset('assets/almaclinic/') }}/js/jquery.waypoints.min.js"></script>
    <script src="{{ asset('assets/almaclinic/') }}/js/jquery.fancybox.min.js"></script>
    <!-- <script src="./js/jquery-ui.min.js"></script> -->
    <script src="{{ asset('assets/almaclinic/') }}/js/swiper.min.js"></script>
    <script src="{{ asset('assets/almaclinic/') }}/js/jquery.js"></script>
    <script src="{{ asset('assets/almaclinic/') }}/js/slick.min.js"></script>
    <script src="{{ asset('assets/almaclinic/') }}/js/jquery.nice-select.min.js"></script>
    <script src="{{ asset('assets/almaclinic/') }}/js/fotorama.js"></script>
    <script src="{{ asset('assets/almaclinic/') }}/js/lightgallery.js"></script>
    <script src="{{ asset('assets/almaclinic/') }}/js/lg-thumbnail.js"></script>
    <script src="{{ asset('assets/almaclinic/') }}/js/owl.carousel.min.js"></script>


    <script src="{{ asset('assets/almaclinic/js/index.js') }}"></script>
