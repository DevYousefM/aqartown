...
<head>
    ...
    <link rel="stylesheet" href="{{ asset(access_public() . 'assets/cangrow/css/aos/aos.min.css') }}">
    ...
    <script type="application/ld+json">
  {
    ...
    <link rel="stylesheet" href="{{ asset(access_public() . 'assets/cangrow/css/style.min.css') }}">
                ...
                <div class="popup__body">
                    <div class="popup__content formBlock">
                        <button class="close" type="button">
                            <img class="w-100"
                                src="{{ asset(access_public() . 'assets/cangrow/images/svg/close-mobile.svg') }}"
                                alt="Close">
                        </button>
                ...
                <div class="row">
                    <div class="col top-panel align-items-center d-flex justify-content-between">
                        <a href="{{ route('front.index', $sign) }}" class="logo"><img
                                src="{{ asset(access_public() . 'assets/images/' . $gs->logo) }}" alt="Logo"></a>
...
@if (!empty($ps->w_phone))
 ...
 @endif 
	...
	<script src="{{ asset(access_public() . 'assets/cangrow/js/scripts.min.js') }}"></script>
	<script src="{{ asset(access_public() . 'assets/cangrow/js/aos/aos.min.js') }}"></script>
	<script src="{{ asset(access_public() . 'assets/cangrow/js/aos/aos-settings.js') }}"></script>
	<!-- Magnific Popup core JS file -->
	<script src="{{ asset(access_public() . 'assets/cangrow/js/jquery.magnific-popup.min.js') }}"></script>
	<script src="{{ asset(access_public() . 'assets/cangrow/js/counters.js') }}"></script>
