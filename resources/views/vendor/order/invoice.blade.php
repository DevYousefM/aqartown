                        ...
                        <div class="col-lg-6 text-right">
                            <a class="btn  add-newProduct-btn print"
                                href="{{ route('vendor-order-print', $order->order_number) }}" target="_blank"><i
                                    class="fa fa-print"></i> {{ $langg->lang607 }}</a>
                        </div>
                    </div>
                </div>
                <br>
                                        ...
                                        <tfoot>
                                            ...
                                            @if (Auth::user()->id == $order->vendor_shipping_id)
                                                @if ($order->shipping_cost != 0)
                                                    <tr>
                                                        <td colspan="2">
                                                            {{ $langg->lang598 }}({{ $order->currency_sign }})</td>
                                            ...
                                            @if (Auth::user()->id == $order->vendor_packing_id)
                                                @if ($order->packing_cost != 0)
                                                    <tr>
                                                        <td colspan="2">
                                                            {{ $langg->lang596 }}({{ $order->currency_sign }})</td>
                                            ...
                                            @if ($order->tax != 0)
                                                <tr>
                                                    <td colspan="2">{{ $langg->lang599 }}({{ $order->currency_sign }})
                                                    </td>
                                                    @php
