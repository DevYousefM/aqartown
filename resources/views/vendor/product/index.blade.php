            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="javascript:;">units </a>
                        </li>
                        <li>
                            <a href="{{ route('vendor-prod-index', ['lang' => $sign]) }}">all units</a>
                        </li>
                    </ul>
                </div>
            </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var table = $('#geniustable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('vendor-prod-datatables', ['lang' => $sign]) }}',
            columns: [{
                    data: 'name',
                    name: 'name'
                },
        ...
        $(function() {
            $(".btn-area").append('<div class="col-sm-4 table-contents">' +
                '<a class="add-btn" href="{{ route('vendor-prod-physical-create', ['lang' => $sign]) }}">' +
                '<i class="fas fa-plus"></i> <span class="remove-mobile">add new<span>' +
                '</a>' +
                '</div>');
        });
