                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('admin-page-store') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="slug_ar"
                                            placeholder="{{ __('Arabic Slug') }}" required=""
                                            value="{{ Request::old('slug_ar') }}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="tawk-area">
                                            <textarea name="facebook_pixel"></textarea>
                                        </div>
                                    </div>
                                </div>
