            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="javascript:;">{{ __('Customer Cart') }}</a>
                        </li>
                        <li>
                            <a href="javascript:;">{{ __('Customer Cart Details') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($product['item']['user_id'] != 0)
                                                    ...
                                                    @if (isset($user))
                                                        <a target="_blank"
                                                            href="{{ route('front.product', ['slug' => $product['item']['slug'], 'lang' => 'en']) }}">{{ strlen($product['item']['name']) > 30 ? substr($product['item']['name'], 0, 30) . '...' : $product['item']['name'] }}</a>
                                                    @else
                                                        <a target="_blank"
                                                            href="{{ route('front.product', ['slug' => $product['item']['slug'], 'lang' => 'en']) }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($dproduct['user_id'] != 0)
                                                        ...
                                                        @if (isset($user))
                                                            <a target="_blank"
                                                                href="{{ route('front.product', ['slug' => $dproduct['slug'], 'lang' => 'en']) }}">{{ strlen($dproduct['name']) > 30 ? substr($dproduct['name'], 0, 30) . '...' : $dproduct['name'] }}</a>
                                                        @else
                                                            <a target="_blank"
                                                                href="{{ route('front.product', ['slug' => $dproduct['slug'], 'lang' => 'en']) }}">
