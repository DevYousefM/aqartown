...
@section('content')
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Edit Slider') }} <a class="add-btn"
                            href="{{ route('admin-mobilesetting-index') }}"><i class="fas fa-arrow-left"></i>
                            {{ __('Back') }}</a></h4>
                    <ul class="links">
                        <li>
                                    ...
                                    <div class="col-lg-7">
                                        <div class="img-upload full-width-img">
                                            <div id="image-preview" class="img-preview"
                                                style="background: url({{ $data->photo ? asset(access_public() . 'assets/images/sliders/' . $data->photo) : asset(access_public() . 'assets/images/noimage.png') }});">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <select name="linked" required="">
                                            ...
                                            <option {{ $data->linked == 1 ? 'selected' : '' }} value="1">Product
                                            </option>
                                            <option {{ $data->linked == 2 ? 'selected' : '' }} value="2">Category
                                            </option>
                                            <option {{ $data->linked == 3 ? 'selected' : '' }} value="3">Brand
                                            </option>
                                            <option {{ $data->linked == 4 ? 'selected' : '' }} value="4">Sub Category
                                            </option>

                                            <option {{ $data->linked == 5 ? 'selected' : '' }} value="5">Offer page
                                            </option>
                                        </select>
                                    </div>
                                </div>
