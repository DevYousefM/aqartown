                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('admin-prod-mobile-update', $data->id) }}"
                                ...
                                <input type="hidden" id="feature_photo" name="mobile_photo"
                                    value="{{ $data->mobile_photo }}" accept="image/*">
