    ...
    <div class="content-area">
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            line-height: 1em;
                            padding: 2rem 0;
                            text-align: center;" @endif>{{ __('WebSite Setting') }}</label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="input-field"
                                                        ...
                                                        name="name_ar" required="" value="{{ $data->name_ar }}">
                                                </div>
                                            </div>
        ...
        --> <input class="d-inline-block mybtn1" type="file"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <a href="javascript" class="set-gallery set-gallery-web"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4 col-sm-6">
                                                                                ...
                                                                                <input type="number" name="size_qty[]"
                                                                                    ...
                                                                                    value="{{ !empty($data->size_qty) ? $data->size_qty[$key] : '' }}">
                                                                            </div>
                                                                            <div class="col-md-4 col-sm-6">
                                                                                <label>
                                                                                    {{ __('Size Price') }} :
                                                                                ...
                                                                                <input type="number" name="size_price[]"
                                                                                    ...
                                                                                    value="{{ !empty($data->size_price) ? $data->size_price[$key] : '' }}">
                                                                            </div>
                                            ...
                                            <div class="{{ count($colors) > 0 ? '' : 'showbox' }}"
                                                id="size-color-display">
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                    </div>
                                                    <div class="col-lg-7">
                                                        ...
                                                        <a href="javascript:;" id="size-color-btn" class="add-more"><i
                                                                class="fas fa-plus"></i>{{ __('Add More Color For Sizes') }}
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-7">
                                                    <ul class="list">
                                                        <li>
                                                            ...
                                                            <label
                                                                for="check3">{{ __('Allow Product Colors') }}</label>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <ul class="list">
                                                        <li>
                                                            <input class="free_ship" name="free_ship" type="checkbox"
                                                                id="free_ship" value="1"
                                                                {{ $data->free_ship == 1 ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-lg-7">
                                                        ...
                                                        <div class="checkbox-wrapper">
                                                            <input type="checkbox" name="measure_check"
                                                                class="checkclick1" id="allowProductMeasurement"
                                                                value="1"
                                            ...
                                            <div class="{{ $data->measure == null ? 'showbox' : '' }}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-1"><input name="scale" type="number"
                                                            class="input-field" min="1"
                                                            value="{{ $data->scale }}"></div>
                                            ...
                                            <div
                                                class="{{ $data->meta_tag == null && strip_tags($data->meta_description) == null && $data->title == null && $data->title_ar == null ? 'showbox' : '' }}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field"
                                                            placeholder="{{ __('Enter Product Arabic Title') }}"
                                                            name="title_ar" value="{{ $data->title_ar }}">
                                                    </div>
                                                </div>
              ...
              <input name="trial_period" type="number" min="0" class="input-field" placeholder="{{ __('trial period') }}" value="{{ $data->trial_period }}">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            @forelse($Related as $key=>$r)
                                                                @php
                                                                    $p = App\Models\Product::where(
                                                                        'id',
                                                                        $r->related_id,
                                                                    )->first();
                                                                @endphp
                                                                <tr>
                                                                    <th style="padding: 7px;" scope="row">
                                                                        {{ $key + 1 }}</th>
                                                                    @if ($p)
                                                                        <td>{{ $p->name }}</td>
                                                                    @else
                                                                    ...
                                                                    <td><a href="{{ route('admin-related-delete', $r->id) }}"
                                                                            class="delete"><i
                                                            ...
                                                            @empty
                                                                <tr style="text-align: center;">
                                                                    <th colspan="3" style="text-align: center;"
                                                                        scope="row">No Related Product</th>
                                    ...
                                    <div class="tab-2">
                                        <label for="tab2-2" class="label"
                                            @if ($gs->light_dark == 0) style="color: #fff; cursor: pointer;
                                                    display: block;
                                                    font-size: 1.1em;
                                                    font-weight: 800;
                                                    line-height: 1em;
                                                 ...
                                                 @else
                                                   ...
                                                   style="color: black; cursor: pointer;
                                                    ...
                                                    line-height: 1em;
                                                    padding: 2rem 0;
                                                    text-align: center;" @endif>{{ __('Mobile Setting') }}</label>
                            ...
                            <i class="icofont-upload-alt"></i> {{ __('Upload Image Here') }}-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <a href="javascript" class="set-gallery set-gallery-mobile"
                                                        data-toggle="modal" data-target="#setgallerymobile">
                                                        <input type="hidden" id="id_mobile"
                                                            value="{{ $data->id }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input name="mobile_price" type="number" class="input-field"
                                                        placeholder="{{ __('e.g 20') }}" step="0.1"
                                                        min="0" value="{{ $data->mobile_price }}">
                                                </div>
                                            </div>
