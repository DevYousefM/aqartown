                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <div class="checkbox-wrapper">
                                            <input type="checkbox" name="feature" value="1" class="checkclick3"
                                                id="allowProductfeature" {{ $data->feature != 0 ? 'checked' : '' }}>
                                            <label
                                                for="allowProductfeature">{{ __('Allow Product feature settings ') }}</label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <select name="subscription_type" class>
                                                <option value="Days"
                                                    {{ $data->subscription_type == 'Days' ? 'selected' : '' }}>Days
                                                </option>
                                                <option value="Months"
                                                    {{ $data->subscription_type == 'Months' ? 'selected' : '' }}>Months
                                                </option>
                                                <option value="Years"
                                                    {{ $data->subscription_type == 'Years' ? 'selected' : '' }}>Years
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                @forelse($Related as $key=>$r)
                                                    ...
                                                    @endphp
                                                    <tr>
                                                        <th style="padding: 7px;" scope="row">{{ $key + 1 }}
                                                        </th>
                                                        @if ($p)
                                                            <td>{{ $p->name }}</td>
                                                        @else
                                                        ...
                                                        <td><a href="{{ route('admin-related-delete', $r->id) }}"
                                                                class="delete"><i class="fas fa-trash-alt"></i> </a></td>
                                                    </tr>
                                                @empty
