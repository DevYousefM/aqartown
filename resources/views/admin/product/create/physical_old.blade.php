                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4 col-sm-4">
                                                                        ...
                                                                        <div class="color-area">
                                                                            ...
                                                                            <div class="input-group ">
                                                                                <input type="number" name="color_price[]"
                                                                                    value="0" min="0"
                                                                                    class="input-field " />
                                            ...
                                            <div class="showbox">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-1"><input name="scale" type="number"
                                                            class="input-field" min="1" value="1"></div>
          ...
          <input name="trial_period" type="number" min="0" class="input-field" placeholder="{{ __('trial period') }}" value="0">
                                    ...
                                    <div class="tab-2">
                                        <label for="tab2-2" class="label"
                                            @if (!empty($gs->light_dark)) @if ($gs->light_dark == 0)
 ...
 style="color: black; cursor: pointer;
                                        ...
                                        <div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="row">
                                                        <div class="panel panel-body">
                                                            <img class="span4 mobile text-center" id="landscapes"
                                                                style="width: 400px; height: 400px; border: 1px dashed black;">
    ...
    --> <input class="sm-btn d-inline-block mybtn1" type="file"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <a href="#" class="set-gallery set-gallery-mobile"
