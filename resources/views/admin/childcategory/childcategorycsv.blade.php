        ...
        <div class="add-product-content">
            <div class="row">
                <div class="col-lg-12 p-5">
                    ...
                    <form id="geniusform" action="{{ route('admin-childcat-importsubmit') }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-right">
                                <span style="margin-top:10px;"><a class="btn btn-primary"
                                        href="{{ asset(access_public() . 'assets/test-childcategory.xlsx') }}">{{ __('Download Sample Excal') }}</a></span>
