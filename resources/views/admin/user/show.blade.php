                                ...
                                <div class="col-md-4">
                                    <div class="user-image">
                                        @if ($data->is_provider == 1)
                                            <img src="{{ $data->photo ? asset($data->photo) : asset(access_public() . 'assets/images/' . $gs->user_image) }}"
                                                alt="No Image">
                                        @else
                                            <img src="{{ $data->photo ? asset(access_public() . 'assets/images/users/' . $data->photo) : asset(access_public() . 'assets/images/' . $gs->user_image) }}"
                                                alt="No Image">
                                        @endif
