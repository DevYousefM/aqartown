                    ...
                    <div class="mr-table allproduct">
                        ...
                        <div class="row" style="margin-top: 31px;">
                            ...
                            <div class="col-lg-12" style="display:contents">
                                ...
                                <form action="{{ route('admin-subcat-all') }}" method="post" enctype="multipart/form-data"
                                ...
                                <form action="{{ route('admin-subcat-activate') }}" method="post"
                                ...
                                <form action="{{ route('admin-subcat-deleted') }}" method="post"
