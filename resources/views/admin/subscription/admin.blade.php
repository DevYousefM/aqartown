...
-->
  ...
  <body>
      ...
      <!--<script src="{{ asset('public/assets/vendor/unisharp/laravel-ckeditor/ckeditor.js') }}"></script>-->
      <!-- <script src="https://cdn.ckeditor.com/4.14.1/standard/ckeditor.js"></script>-->
      <!--	<script src="https://cdn.ckeditor.com/ckeditor5/20.0.0/classic/ckeditor.js"></script>-->
      <!--   <script src="{{ asset('public/assets/unisharp/laravel-ckeditor/adapters/jquery.js') }}"></script>-->
