                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusformdata" action="{{ route('admin-points-update', $data->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="input-field col-lg-5" name="limited"
                                            placeholder="{{ __('Enter Limited') }}" required=""
                                            value="{{ $data->limited }}">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="input-field col-lg-5" name="points"
                                            placeholder="{{ __('Enter Points') }}" required=""
                                            value="{{ $data->points }}">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="number" class="input-field" name="days"
                                    ...
                                    <div class="col-lg-7">
                                        <div class="img-upload">
                                            <div id="image-preview" class="img-preview"
                                                style="background: url({{ $data->photo ? asset(access_public() . 'assets/images/points/' . $data->photo) : asset(access_public() . 'assets/images/noimage.png') }});">
