                    ...
                    <div class="mr-table allproduct">
                        ...
                        <div class="table-responsiv">
                            <div class="col-sm-12 table-contents">
                                <a class="add-btn" data-href="{{ route('admin-pointss-create') }}" id="add-data"
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="mr-table allproduct">
                        ...
                        <div class="table-responsiv">
                            <div class="col-sm-12 table-contents">
                                <a class="add-btn" data-href="{{ route('admin-pointss-piece-create') }}" id="add-data"
                                    data-toggle="modal" data-target="#modal1">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="mr-table allproduct">
                        ...
                        <div class="table-responsiv">
                            <div class="col-sm-12 table-contents">
                                <a class="add-btn" data-href="{{ route('admin-pointss-free-create') }}" id="add-data"
                                    data-toggle="modal" data-target="#modal1">
