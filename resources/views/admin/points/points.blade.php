                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusformdata" action="{{ route('admin-points-updates') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="number" class="input-field" name="points"
                                            placeholder="{{ __('Enter points') }}" step="0.1" required=""
                                            value="{{ $data->points }}">
                                    </div>
                                </div>
