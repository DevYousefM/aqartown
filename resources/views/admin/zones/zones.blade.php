												...
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
													 ...
													 <tbody>
													     ...
													     <td> <a href="javascript:;" data-href="{{route('admin-zones-delete-city',$p->id)}}" data-toggle="modal" data-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></td>   
													     </tr>
