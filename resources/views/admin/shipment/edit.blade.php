                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusformdata" action="{{ route('admin-shipment-update', $data->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="text" class="input-field less-width" name="facebook"
                                            placeholder="{{ __('map') }}" value="{{ $data->facebook }}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="text" class="input-field less-width" name="desc"
                                            placeholder="{{ __('phone') }}" value="{{ $data->desc }}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="text" class="input-field less-width" name="desc_ar"
                                            placeholder="{{ __('email') }}" value="{{ $data->desc_ar }}">
                                    </div>
                                </div>
                                <!--
                                <div class="row">
