...
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusformdata" action="{{ route('admin-shipment-store') }}" method="POST"
    ...
    @endforeach
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="name_ar"
                                            placeholder="{{ __('Arabic Name') }}" required="" value="">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="text" class="input-field less-width" name="facebook"
                                            placeholder="{{ __('map') }}" value="">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="text" class="input-field less-width" name="desc"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="text" class="input-field less-width" name="desc_ar"
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-7">
                                    <textarea type="text" class="input-field" name="desc_ar" placeholder="{{ __('Arabic Description') }}"
                                        value=""> </textarea>
                                  </div>
                                </div>
                                 ...
                                 <div class="row">
                                              ...
                                              <div class="col-lg-7">
                                                <div class="img-upload">
                                                    <div id="image-preview" class="img-preview" style="background: url({{ asset(access_public() . 'assets/images/noimage.png') }});">
