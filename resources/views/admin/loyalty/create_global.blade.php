                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusformdata" action="{{ route('admin-loyalty-global-message-store') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="number" class="input-field col-lg-5" name="min" min="0"
                                            placeholder="{{ __('Enter Min Points') }}" required="" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="number" class="input-field col-lg-5" name="max" min="0"
                                            placeholder="{{ __('Enter Max Points') }}" required="" value="">
                                    </div>
                                </div>
