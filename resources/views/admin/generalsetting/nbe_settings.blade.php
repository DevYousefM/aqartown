                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('admin-gs-update') }}" method="POST"
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="tawk-area">
                                            <input type="text" class="input-field" placeholder="{{ __('Api  Name') }}"
                                                name="name_nbe" value="{{ $gs->name_nbe }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="tawk-area">
                                            <input type="text" class="input-field"
                                                placeholder="{{ __('Api Password ') }}" name="password_nbe"
                                                value="{{ $gs->password_nbe }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="tawk-area">
                                            <input type="text" class="input-field"
                                                placeholder="{{ __('Merchant Name') }}" name="merchant_nbe"
                                                value="{{ $gs->merchant_nbe }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="tawk-area">
                                            <input type="text" class="input-field" placeholder="{{ __('Merchant Id') }}"
                                                name="merchant_id_nbe" value="{{ $gs->merchant_id_nbe }}">
                                        </div>
                                    </div>
                                </div>
