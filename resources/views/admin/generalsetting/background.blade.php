                ...
                <div class="col-xl-4 col-md-6">
                    <div class="special-box bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST"
                            ...
                            @include('includes.admin.form-both')
                            <div class="currrent-logo">
                                <img src="{{ $gs->about_background ? asset(access_public() . 'assets/images/' . $gs->about_background) : asset(access_public() . 'assets/images/noimage.png') }}"
                                    alt="">
                            </div>
                            <div class="set-logo">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="special-box bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST"
                            ...
                            @include('includes.admin.form-both')
                            <div class="currrent-logo">
                                <img src="{{ $gs->service_background ? asset(access_public() . 'assets/images/' . $gs->service_background) : asset(access_public() . 'assets/images/noimage.png') }}"
                                    alt="">
                            </div>
                            <div class="set-logo">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="special-box bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST"
                            ...
                            @include('includes.admin.form-both')
                            <div class="currrent-logo">
                                <img src="{{ $gs->contact_background ? asset(access_public() . 'assets/images/' . $gs->contact_background) : asset(access_public() . 'assets/images/noimage.png') }}"
                                    alt="">
                            </div>
                            <div class="set-logo">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="special-box bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST"
                            ...
                            @include('includes.admin.form-both')
                            <div class="currrent-logo">
                                <img src="{{ $gs->about_page_background ? asset(access_public() . 'assets/images/' . $gs->about_page_background) : asset(access_public() . 'assets/images/noimage.png') }}"
                                    alt="">
                            </div>
                            <div class="set-logo">
