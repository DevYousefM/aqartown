                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="sign"
                                            placeholder="{{ __('en') }}" required="" value="en">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-10">
                                        <nav>
                                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                                ...
                                                <a class="nav-item nav-link" id="nav-profile-tab" style="display:none"
                                                    data-toggle="tab" href="#nav-profile" role="tab"
                                                    aria-controls="nav-profile"
                                                    aria-selected="false">{{ __('Panel') }}</a>
                                                <a class="nav-item nav-link" id="nav-about-tab" style="display:none"
                                        ...
                                        <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                            ...
                                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang16"
                                                            placeholder="About us" required="" value="About us">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang11"
                                                            placeholder="What we do" required="" value="What we do">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang221"
                                                            placeholder="Gallery" required="" value="Gallery">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang12"
                                                            placeholder="view more" required="" value="view more">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang13"
                                                            placeholder="Read The Latest News" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang220"
                                                            placeholder="Recent Articles" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang1"
                                                            placeholder="Call Us On 1234 456 780" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang2"
                                                            placeholder="or Enter Your Details Team" required=""
                                                            value="or Enter Your Details Team">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="left-area">
                                                            <h4 class="heading"> Will Contact You To Discuss Your Event *
                                                            </h4>
                                                            <p class="sub-heading">(In Any Language)</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang7"
                                                            placeholder="Call Now" required="" value="Call Now">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang8"
                                                            placeholder="Mail Info" required="" value="Mail Info">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang38"
                                                            placeholder="Social Sharing" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang39"
                                                            placeholder="Comments" required="" value="Comments">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang40"
                                                            placeholder="Client's Comment" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang46"
                                                            placeholder="Submit A Comment" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang43"
                                                            placeholder="Recent Events" required=""
                                                            value="Recent Events">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang44"
                                                            placeholder="Flickr Photos" required=""
                                                            value="Flickr Photos">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang4"
                                                            placeholder="What People Say?" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang5"
                                                            placeholder="Client's Testimonials" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang9"
                                                            placeholder="History" required="" value="History">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang10"
                                                            placeholder="Our Team" required="" value="Our Team">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="left-area">
                                                            <h4 class="heading">Meet the people who make awesome stuffs *
                                                            </h4>
                                                            <p class="sub-heading">(In Any Language)</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang15"
                                                            placeholder="Sponsored By" required=""
                                                            value="Sponsored By">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang19"
                                                            placeholder="Faq's" required="" value="Faq's">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang25"
                                                            placeholder="Amazing Partners & Sponsors" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang200"
                                                            placeholder="Coach Tracker" required=""
                                                            value="Coach Tracker">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang230"
                                                            placeholder="Track Your Coach in Real Time." required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang201"
                                                            placeholder="Overview" required="" value="Overview">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang202"
                                                            placeholder="Features" required="" value="Features">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang203"
                                                            placeholder="Speaker" required="" value="Speaker">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang231"
                                                            placeholder="Get In Touch" required=""
                                                            value="Get In Touch">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang232"
                                                            placeholder="Register Now" required=""
                                                            value="Register Now">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang250"
                                                            placeholder="Biggest Festivals" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang909"
                                                            ...
                                                            required=""
                                                            value="Subscribe for updates & special offers!">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang807"
                                                            placeholder="All Notifications" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang808"
                                                            placeholder="Notifications" required=""
                                                            value="Notifications">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang809"
                                                            placeholder="Loyalty Program" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang810"
                                                            placeholder="Referrals program" required=""
                                                            value="Referrals program">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang811"
                                                            placeholder="Wallet" required="" value="Wallet">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang812"
                                                            placeholder="Promo Codes" required=""
                                                            value="Promo Codes">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang813"
                                                            placeholder="Address List" required=""
                                                            value="Address List">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang815"
                                                            placeholder="Discount off" required=""
                                                            value="Discount off">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang816"
                                                            placeholder="Limited Purchase" required=""
                                                            value="Limited Purchase">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang817"
                                                            placeholder="Exp" required="" value="Exp">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang818"
                                                            placeholder="Copy Code" required="" value="Copy Code">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang820"
                                                            placeholder="points" required="" value="points">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang822"
                                                            placeholder="Points For Copoun" required=""
                                                            value="Points For Copoun">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang823"
                                                            placeholder="times to Use" required=""
                                                            value="times to Use">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang824"
                                                            placeholder="Times" required="" value="Times">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang825"
                                                            placeholder="Referrals Code" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang826"
                                                            placeholder="Partners" required="" value="Partners">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang827"
                                                            placeholder="No Use Wallet" required=""
                                                            value="No Use Wallet">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang828"
                                                            placeholder="Use Wallet" required=""
                                                            value="Use Wallet">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang829"
                                                            placeholder="Shipment Price" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang830"
                                                            placeholder="Refelars Code To Get Points" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang299"
                                                            ...
                                                            required="" value="Enter Transaction ID & Press Enter">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang772"
                                                            placeholder="Order Tracking" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang774"
                                                            placeholder="View Tracking" required=""
                                                            value="View Tracking">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang775"
                                                            placeholder="No Order Found" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang258"
                                                            ...
                                                            required="" value="You are about to delete this Seller.">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang391"
                                                            ...
                                                            required="" value="You are about to delete this Ticket.">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang901"
                                                            placeholder="PAGES" required="" value="PAGES">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang906"
                                                            placeholder="About" required="" value="About">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang910"
                                                            placeholder="Subscribe Message" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang900"
                                                            placeholder="Shopping Cart" required=""
                                                            value="Shopping Cart">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang800"
                                                            placeholder="Paid" required="" value="Paid">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang595"
                                                            placeholder="Qty" required="" value="Qty">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang609"
                                                            placeholder="Type" required="" value="Type">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang621"
                                                            placeholder="Done" required="" value="Done">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang636"
                                                            placeholder="Used" required="" value="Used">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang652"
                                                            ...
                                                            required="" value="(Number of quantity of this size)">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang673"
                                                            placeholder="None" required="" value="None">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang674"
                                                            placeholder="Gram" required="" value="Gram">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang696"
                                                            placeholder="Link" required="" value="Link">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" class="input-field" name="lang710"
                                                            placeholder="File" required="" value="File">
                                                    </div>
                                                </div>
