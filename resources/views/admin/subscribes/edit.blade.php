                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusformdata" action="{{ route('admin-subscribes-update', $data->id) }}"
                                        ...
                                        <select id="user" name="user_id" required="">
                                            @foreach ($users as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ $item->id == $data->user_id ? 'selected' : '' }}>{{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field less-width" name="package_price"
                                            placeholder="" required="" value="{{ $data->package_price }}">
                                    </div>
                                </div>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field less-width" name="paid_via"
                                            placeholder="{{ __('Enter paid via') }}"
                                            value="{{ $data->paid_via }}"><span></span>
                                    </div>
                                </div>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="text-editor">
                                            <textarea type="text" class="nic-edit-p" name="package_details" placeholder="{{ __('Enter package details') }}"
                                                value="">{{ $data->package_details }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
