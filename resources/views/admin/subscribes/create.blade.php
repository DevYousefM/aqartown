                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusformdata" action="{{ route('admin-subscribes-create') }}" method="POST"
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field less-width" name="paid_via"
                                            placeholder="{{ __('Enter paid via') }}" value=""><span></span>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <button class="addProductSubmit-btn"
                                            type="submit">{{ __('Create Subscribe') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
