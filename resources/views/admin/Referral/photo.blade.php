                            ...
                            <form id="geniusform" action="{{ route('admin-photo-update') }}" method="POST"
                                    ...
                                    <div class="col-lg-7">
                                        <div class="img-upload">
                                            <div id="image-preview" class="img-preview"
                                                style="background: url({{ $data->wallet_photo ? asset('assets/images/' . $data->wallet_photo) : asset('assets/images/noimage.png') }});">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="img-upload">
                                            <div id="image-preview" class="img-preview"
                                                style="background: url({{ $data->loyalty_photo ? asset('assets/images/' . $data->loyalty_photo) : asset('assets/images/noimage.png') }});">
                                                <label for="image-upload" class="img-label" id="image-label"><i
                                                        class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
