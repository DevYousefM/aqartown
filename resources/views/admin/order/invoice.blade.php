                                    ...
                                    <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                        ...
                                        <tfoot>
                                            ...
                                            @if ($order->shipping_cost != 0)
                                                <tr>
                                                    <td colspan="2">
                                                        {{ __('Shipping Cost') }}({{ $order->currency_sign }})</td>
                                            ...
                                            @if ($order->packing_cost != 0)
                                                <tr>
                                                    <td colspan="2">
                                                        {{ __('Packaging Cost') }}({{ $order->currency_sign }})</td>
                                            ...
                                            @if ($order->shipping_price != 0)
                                                <tr>
                                                    <td colspan="2">
                                                        {{ __('Shipping Price') }}({{ $order->currency_sign }})</td>
                                            ...
                                            @if ($order->wallet != 0)
                                                <tr>
                                                    <td colspan="2">
                                                        {{ __('Wallet Discount') }}({{ $order->currency_sign }})</td>
