                                    ...
                                    <tbody>
                                        ...
                                        @if ($order->shipment_id == 6 && $order->status == 'processing')
                                            <tr>
                                                ...
                                                <th width="10%">:</th>
                                                <td width="45%"><a
                                                        class="btn btn-success"href="{{ route('admin-order-abs', $order->Awb) }}">{{ $order->Awb }}</a>
                                                </td>
                                        ...
                                        @if ($order->shipment_id == 7 && $order->status == 'processing')
                                            <tr>
                                                ...
                                                <th width="10%">:</th>
                                                <td width="45%"><a
                                                        class="btn btn-success"href="{{ route('admin-order-mylerz', $order->barcod) }}">{{ $order->barcod }}</a>
                                                </td>
                                                <td width="45%"><a
                                                        class="btn btn-success"href="{{ route('admin-mylerz-index', $order->barcod) }}">
                                                        PDF </a></td>
                                        ...
                                        @if ($order->shipment_id == 4 && $order->status == 'processing')
                                            <tr>
                                                ...
                                                <td><a class="btn sendEmail"
                                                        href="{{ route('admin-order', $order->serial) }}"> Status</a></td>
                                                &nbsp;&nbsp;
