...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Info budgets') }}</h4>
                    <ul class="links">
                        <li>
                            <a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
                        </li>
                        <li>
                            <a href="{{ route('admin-info-budgets-index') }}">{{ __('Info budgets') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var table = $('#geniustable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin-info-budgets-datatables') }}',
            columns: [{
                    data: 'checkbox',
                    name: 'checkbox'
                },
        ...
        $(function() {
            $(".btn-area").append('<div class="col-sm-4 table-contents">' +
                '<a class="add-btn" data-href="{{ route('admin-info-budgets-create') }}" id="add-data" data-toggle="modal" data-target="#modal1">' +
