            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li><a href="javascript:;">{{ __('Manage products') }}</a></li>
                        <li>
                            <a href="{{ route('admin-brand-index') }}">{{ __('products') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="mr-table allproduct">
                        ...
                        <div class="row" style="margin-top: 31px;">
                            <div class="col-lg-12" style="display:contents">
                                ...
                                <form action="{{ route('admin-brand-activate') }}" method="post"
                                ...
                                <form action="{{ route('admin-brand-deleted') }}" method="post"
    ...
    <div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-center">
                        {{ __('You are about to delete this Brand. Everything under this Brand will be deleted') }}.</p>
