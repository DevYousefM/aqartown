							...
							<div class="add-product-content">
								<div class="row">
									<div class="col-lg-12 p-5">
					                      ...
					                      <form id="geniusform" action="{{route('admin-subcat-importsubmit')}}" method="POST" enctype="multipart/form-data">
					                        {{csrf_field()}}
                              ...
                              @include('includes.admin.form-both')  
									 ...
									 <span style="margin-top:10px;"><a class="btn btn-primary" href="{{asset('assets/test-subcategory.xlsx')}}">{{ __("Download Sample Excal") }}</a></span>
