...
@section('content')  
					...
					<div class="content-area">
                        ...
                        @include('includes.admin.form-success')  
										...
										<div class="table-responsiv">
										     <div class="col-sm-12 table-contents">
                                                    	<a class="add-btn" data-href="{{route('admin-points-edits')}}" id="add-data" data-toggle="modal" data-target="#modal1">
                                                      <i class="fas fa-edit"></i> {{ __('Edit Points For 1 Pound') }}
                                                      </a>
                                                      </div>  <br>
                                                      <div class="col-sm-12 table-contents">
                                                    	<a class="add-btn" data-href="{{route('admin-points-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">
                        ...
                        @include('includes.admin.form-success')  
										...
										<div class="table-responsiv">
										    <div class="col-sm-12 table-contents">
                                                    	<a class="add-btn" data-href="{{route('admin-message-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">
                        ...
                        @include('includes.admin.form-success')  
										...
										<div class="table-responsiv">
										    <div class="col-sm-12 table-contents">
                                                    	<a class="add-btn" data-href="{{route('admin-global-message-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">
