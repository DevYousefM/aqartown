...
@section('content')
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Edit Certificates image') }} <a class="add-btn" href="{{route('admin-ads-index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      <ul class="links">
                        <li>
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea class="form-control" name="title_ar" id="subtitle_text" rows="5"  placeholder="{{ __('Enter Arabic Title Text') }}">{{$data->title_ar}}</textarea>
                                                </div>
                                            </div>
