        ...
        <div class="add-product-content">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            ...
                                            <p class="sub-heading">
                                                {{ __('(select category or brand or sub category or child category)') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <select id="what" name="what" required="">
                                            ...
                                            <option value="cat" {{ $data->category_id != null ? 'selected' : '' }}>
                                                Category</option>
                                            <option value="subcat" {{ $data->subcat_id != null ? 'selected' : '' }}>Sub
                                                Category</option>
                                            <option value="childcat" {{ $data->childcat_id != null ? 'selected' : '' }}>
                                                Child Category</option>
                                            <option value="brand" {{ $data->brand_id != null ? 'selected' : '' }}>Brand
                                            </option>
                            ...
                            <div class="col-lg-7">
                                <select id="subcat_id" name="subcat_id">
                                    ...
                                    @foreach ($subcats as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $item->id == $data->subcat_id ? 'selected' : '' }}>{{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
            ...
            <div class="row hidden">
                ...
                <div class="col-lg-7">
                    <input type="text" class="input-field less-width" name="times"
                        placeholder="{{ __('Enter Value') }}" value="{{ $data->times }}"><span></span>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <input type="text" class="input-field col-lg-5" name="limited"
                        placeholder="{{ __('Enter Limited') }}" required="" value="{{ $data->limited }}"><span
                        class="col-lg-1">{{ $sign->sign }}</span>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <input type="text" class="input-field" name="end_date" id="to"
                        placeholder="{{ __('Select a date') }}" required="" value="{{ $data->end_date }}">
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
