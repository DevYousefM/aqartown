                    ...
                    <div class="mr-table allproduct">
                        ...
                        <div class="row" style="margin-top: 31px;">
                            <div class="col-lg-12" style="display:contents">
                                ...
                                <form action="{{ route('admin-childcat-all') }}" method="post"
                                ...
                                <form action="{{ route('admin-childcat-activate') }}" method="post"
                                ...
                                <form action="{{ route('admin-childcat-deleted') }}" method="post"
