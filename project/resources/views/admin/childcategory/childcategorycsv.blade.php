...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading">{{ __("Child Category Bulk Upload") }}</h4>
											<ul class="links">
												<li>
											...
											<li>
												<a href="{{ route('admin-childcat-index') }}">{{ __("All Child Category") }}</a>
											</li>
												<li>
													<a href="{{ route('admin-childcat-import') }}">{{ __("Bulk Upload") }}</a>
												</li>
											</ul>
									</div>
								</div>
							...
							<div class="add-product-content">
								<div class="row">
									<div class="col-lg-12 p-5">
					                      ...
					                      <form id="geniusform" action="{{route('admin-childcat-importsubmit')}}" method="POST" enctype="multipart/form-data">
					                        {{csrf_field()}}
                              ...
                              @include('includes.admin.form-both')  
									 ...
									 <span style="margin-top:10px;"><a class="btn btn-primary" href="{{asset('assets/test-childcategory.xlsx')}}">{{ __("Download Sample Excal") }}</a></span>
