...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading">{{ __("Users Bulk Upload") }}</h4>
											<ul class="links">
												<li>
											...
											<li>
												<a href="{{ route('admin-user-index') }}">{{ __("All user") }}</a>
											</li>
												<li>
													<a href="{{ route('admin-user-import') }}">{{ __("Bulk Upload") }}</a>
												</li>
											</ul>
									</div>
								</div>
							...
							<div class="add-product-content">
								<div class="row">
									<div class="col-lg-12 p-5">
					                      ...
					                      <form id="geniusform" action="{{route('admin-user-importsubmit')}}" method="POST" enctype="multipart/form-data">
					                        {{csrf_field()}}
                              ...
                              @include('includes.admin.form-both')  
									 ...
									 <span style="margin-top:10px;"><a class="btn btn-primary" href="{{asset('assets/test-user.xlsx')}}">{{ __("Download Sample Excal") }}</a></span>
									   <a class="btn btn-warning" href="{{ route('user.export') }}">Export User Data</a>
