...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading">{{ __("Orders Bulk Upload") }}</h4>
											<ul class="links">
												<li>
											...
											<li>
												...
												<li>
													<a href="{{ route('admin-order-import') }}">{{ __("Bulk Upload") }}</a>
												</li>
											</ul>
									</div>
								</div>
							...
							<div class="add-product-content">
                              ...
                              @include('includes.admin.form-both')  
									 ...
									 <span style="margin-top:10px;"><a class="btn btn-primary" href="{{asset('assets/test-order.xlsx')}}">{{ __("Download Sample Excal") }}</a></span>
											  ...
											  <div class="row justify-content-center">
												  ...
												  <div class="col-lg-12 d-flex justify-content-center text-center">
													  <div class="left-area mr-4">
														  <h4 class="heading">{{ __("Upload a Excel File") }} *</h4>
													  </div>
													  <span class="file-btn">
