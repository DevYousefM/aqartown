                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <th width="10%">:</th>
                                     ...
                                     <td width="45%"><a href="{{route('admin-order-fastlooshow',$order->company_fastlo_api) }}">{{$order->company_fastlo_api}}</td>
                                     <a class="btn btn-success" href="{{url('admin/deletss_api/'.$order->company_fastlo_api) }}">Delete  fastlo shipment</a></td>
                                   ...
                                   @if($order->shipment_id ==6 && $order->status =="processing" )
                                    ...
                                    <tr>
                                        ...
                                        <th width="10%">:</th>
                                        <td width="45%"><a class="btn btn-success"href="{{route('admin-order-abs',$order->Awb) }}">{{$order->Awb }}</a></td>
                                    ...
                                    <tr>
                                        ...
                                        <th width="10%">:</th>
                                        <td width="45%"><a class="btn btn-success"href="{{route('admin-order-mylerz',$order->barcod) }}">{{$order->barcod }}</a></td>
                                        <td width="45%"><a class="btn btn-success"href="{{route('admin-mylerz-index',$order->barcod)  }}">  PDF  </a></td>
                                  ...
                                  @if($order->shipment_id ==2 && $order->status =="processing" )
                                    ...
                                    <th width="10%">:</th>
                                       <td width="45%"><a href="{{url('aramexdetailz/'.$order->aramex_api_numbeer)}}">{{$order->aramex_api_numbeer }}</a></td>
                                    ...
                                    <th width="10%">:</th>
                                     <td width="45%"><a href="{{route('tracks_aramexx',$order->pickuptrack_api)}}">{{$order->pickuptrack_api}}</a>
                                     <a class="btn btn-success" href="{{route('aramexcancell',$order->id_api_aramex)}}">cancel pickup</a></td> 
                                       </tr>@endif
                                    ...
                                    <th width="10%">:</th>
                                    <td><a class="btn sendEmail" href="{{route('admin-order',$order->serial)}}"> Status</a></td>&nbsp;&nbsp;
                                    <td><a class="btn btn-success" href="/admin/generate_pdf?serial={{$order->serial}}&id={{$order->id}}">PDF</a></td>
                                   {{--<td    width="45%"><a class="btn sendEmail" target="_blank" href="{{route('admin-order-printPolice',$order->id)}}">View</a></td>--}}
                                   ...
                                   @if($order->shipment_id  == 4 &&  $order->status == "on delivery")
                                    ...
                                    <th width="45%"><strong></strong>Fedex Serial Number</th>
                                    <th width="10%">:</th>
                                    <td width="45%"><a class="btn btn-success" href="{{route('admin-order',$order->serial)}}">{{$order->serial }}</a></td>
                                  ...
                                  @if($order->shipment_id  == 6 &&  $order->status == "on delivery")
                                    ...
                                    <th width="10%">:</th>
                                    <td width="45%"><a class="btn btn-success" >{{$order->pickup_id}}</a></td>
                                   </tr>
                                  ...
                                  @if($order->shipment_id  == 4 && $order->status == "completed")
                                   ...
                                   @if($order->serial != "" ) <th width="45%"><strong></strong>Fedex Serial Number</th>
                                    <th width="10%">:</th>
                                    <td  width="45%"><a class="btn btn-success" href="{{route('admin-order',$order->serial)}}">{{$order->serial }}</a></td>
                                    <td  width="45%"><a class="btn btn-success" href="{{route('admin-order',$order->serial)}}">Status</a></td>@endif
                                  @if($order->fedex_pic_api != "" )
                                    <th width="45%"><strong></strong>Fedex  pickup id</th>
                                    <th width="10%">:</th>
                                     
                                     <td width="45%"><a class="btn btn-success" >{{$order->fedex_pic_api }}</a></td>@endif
