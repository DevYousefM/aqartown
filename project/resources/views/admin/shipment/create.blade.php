...
<!-- -->
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-3">
                                  <input type="text" class="input-field less-width" name="facebook" placeholder="{{ __('map') }}"  value="">
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-lg-4">
                              ...
                              <div class="col-lg-3">
                                  <input type="text" class="input-field less-width" name="desc" placeholder="{{ __('phone') }}"  value="">
                              </div>
                          </div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-3">
                                  <input type="text" class="input-field less-width" name="desc_ar" placeholder="{{ __('email') }}"  value="">
                              </div>
                          </div>
                          <!--      <div class="row">
                          <div class="col-lg-4">
