                ...
                <div class="row">
                  <div class="col-lg-12">
                   ...
                   <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <input type="text" class="input-field" placeholder="{{ __('Enter  Title') }}" value="{{ $data->title }}" name="title" >
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-lg-4">
                              ...
                              <div class="col-lg-7">
                                  <input type="text" class="input-field" placeholder="{{ __('Enter Arabic Title') }}"  value="{{ $data->title_ar }}" name="title_ar" >
                              </div>
                          </div>
                        <div class="row">
                          <div class="col-lg-4">
