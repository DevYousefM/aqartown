                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('admin-ps-updates') }}" method="POST"
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="email" class="ckeditor form-control"
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field"
                                            placeholder="{{ __('Google Map IFrame') }}" name="map"
                                            value="{{ $data->map }}">
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field"
                                            placeholder="{{ __('Enter Page ID') }}" name="page_id"
                                            value="{{ $data->page_id }}">
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field" placeholder="{{ __('Enter number') }}"
                                            name="w_phone" value="{{ $data->w_phone }}">
                                    </div>
                                </div>
