                    ...
                    <div class="special-box bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST" enctype="multipart/form-data">
                          {{csrf_field()}}   
                             ...
                             @include('includes.admin.form-both')  
                          <div class="currrent-logo">
                            <img src="{{ $gs->about_background ? asset('assets/images/'.$gs->about_background):asset('assets/images/noimage.png')}}" alt="">
                          </div>
                          <div class="set-logo">
                    ...
                    <div class="special-box bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST" enctype="multipart/form-data">
                          {{csrf_field()}}   
                             ...
                             @include('includes.admin.form-both')  
                          <div class="currrent-logo">
                            <img src="{{ $gs->service_background ? asset('assets/images/'.$gs->service_background):asset('assets/images/noimage.png')}}" alt="">
                          </div>
                          <div class="set-logo">
                    ...
                    <div class="special-box bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST" enctype="multipart/form-data">
                          {{csrf_field()}}   
                             ...
                             @include('includes.admin.form-both')  
                          <div class="currrent-logo">
                            <img src="{{ $gs->contact_background ? asset('assets/images/'.$gs->contact_background):asset('assets/images/noimage.png')}}" alt="">
                          </div>
                          <div class="set-logo">
                    ...
                    <div class="special-box bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST" enctype="multipart/form-data">
                          {{csrf_field()}}   
                             ...
                             @include('includes.admin.form-both')  
                          <div class="currrent-logo">
                            <img src="{{ $gs->about_page_background ? asset('assets/images/'.$gs->about_page_background):asset('assets/images/noimage.png')}}" alt="">
                          </div>
                          <div class="set-logo">
