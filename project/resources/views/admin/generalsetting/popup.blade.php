...
-->
                          ...
                          <div class="row justify-content-center">
                              ...
                              <div class="col-lg-6">
                                  <div class="tawk-area">
                                    <textarea class="ckeditor input-field"  name="popup_text" placeholder="{{ __('Popup Text') }}">{{$gs->popup_text}}</textarea>
                                  </div>
                              </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                              ...
                              <div class="col-lg-6">
                                  <div class="tawk-area">
                                    <textarea class=" ckeditor input-field"  name="popup_text_ar" placeholder="{{ __('Popup Text') }}">{{$gs->popup_text_ar}}</textarea>
                                  </div>
                              </div>
                            </div>
