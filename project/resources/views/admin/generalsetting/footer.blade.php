														...
														<div class="featured-keyword-area">
                                                           ...
                                                           $title =    explode(',', $gs->contact_emails);
																...
																<div class="feature-area">
																	...
																	<div class="row">
																		<div class="col-lg-12">
																		<input type="text" name="contact_emails[]" class="input-field" placeholder="{{ __('emails') }}" value="{{ $title[$key] }}">
																		</div>
																...
																<div class="feature-area">
																	...
																	<div class="row">
																		<div class="col-lg-12">
																		<input type="text" name="contact_emails[]" class="input-field" placeholder="{{ __('emails') }}" >
																		</div>
