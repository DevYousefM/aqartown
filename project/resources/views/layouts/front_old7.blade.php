                ...
                <nav id="navigation" class="navigation navigation-landscape">
                    ...
                    <div class="nav-menus-wrapper" style="transition-property: none;">
                        <ul class="nav-menu">
                            ...
                            <li class="active"><a href="{{ route('front.categories',$sign) }}">{{$langg->lang11}}<span
                            ...
                            <!--<li><a >Projects</a></li>-->
                            <li><a href="{{ route('front.products',$sign) }}">{{$langg->lang18}}<span class="submenu-indicator"></span></a>
                                <ul class="nav-dropdown nav-submenu">
                            ...
                            <li><a href="#">{{$langg->lang221}}<span class="submenu-indicator"></span></a>
                                <ul class="nav-dropdown nav-submenu">
                                  @foreach($solutions as $solution)
                                    ...
                                    <li><a href="{{ route('front.solution',['lang'=>$sign , 'slug' => $solution->slug]) }}"> @if($langg->rtl == 1)
...
@endif</a></li>
                            ...
                            <li><a href="#">{{$langg->lang222}}</span></a>
                                <ul class="nav-dropdown nav-submenu">
                                    <li><a class="active" href="{{ route('front.project_video',$sign) }}"> {{$langg->lang20}} </a></li>
                                    <li><a href="{{ route('front.product_video',$sign) }}">{{$langg->lang223}}</a></li>
...
@endif</a></li>
                            ...
                            <div class="col-lg-2 col-md-6 col-sm-12 footer-column">
                                <div class="footer-widget links-widget ml-70">
                                    ...
                                    <div class="widget-content">
                                        <ul class="links clearfix">
                                            <li><a href="{{ route('front.product_video',$sign) }}">{{$langg->lang223}}</a></li>
                                            <li><a href="{{ route('front.project_video',$sign) }}">{{$langg->lang20}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-6 col-sm-12 footer-column">
                                <div class="footer-widget links-widget ml-70">
                                    ...
                                    <div class="widget-content">
                                        <ul class="links clearfix">
                                            <li><a href="{{ route('front.about',$sign) }}">{{$langg->lang12}}</a></li>
                                            <li><a href="{{ route('front.blog',$sign) }}">{{$langg->lang13}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-6 col-sm-12 footer-column">
                                ...
                                ">
                                    ...
                                    <ul class="contact-info">
                                        ...
                                        <li><span><a href="{{ route('front.contact',$sign) }}">  {{$langg->lang2}}</a></span></li>
                                    </ul>
                            ...
                            <li>
                             ...
                             <a href="{{ App\Models\Socialsetting::find(1)->facebook }}">   <i class="fab fa-facebook-f"></i> </a>
                            </li>
                            @endif 
                            @if(App\Models\Socialsetting::find(1)->t_status == 1)          
                            <li>
                               
                             <a href="{{ App\Models\Socialsetting::find(1)->twitter }}"> <i class="fab fa-twitter"></i> </a>
                            </li>
                            @endif 
                            @if(App\Models\Socialsetting::find(1)->l_status == 1)
                            <li>
                                
                           <a href="{{ App\Models\Socialsetting::find(1)->linkedin }}"><i class="fab fa-linkedin"></i> </a>
                            </li>
                            @endif
                            @if(App\Models\Socialsetting::find(1)->i_status == 1)
                            <li>
                               
                               <a href="{{ App\Models\Socialsetting::find(1)->instagram }}"> <i class="fab fa-instagram"></i> </a>
                            </li>
                            @endif
