...
<div class="preloader">
                    ...
                    <ul class="top-header-optional">
                        <li>
                         @if(App\Models\Socialsetting::find(1)->f_status == 1)
                                   ...
                                   <a target="_blank" href="{{ App\Models\Socialsetting::find(1)->instagram }}">  <i class='bx bxl-instagram'></i></a>
                                                @endif 
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                ...
                                @foreach($categories as $category)
                                    <li class="nav-item">
                                       	@if($langg->rtl == 1)
											<a href="{{ route('front.category',['category' => $category->slug_ar, 'lang' => $sign]) }}" class="nav-link" title="{{ $category->name_ar }}">
													{{ $category->name_ar }}</a>
												@else
												<a href="{{ route('front.category',['category' => $category->slug, 'lang' => $sign]) }}" class="nav-link" title="{{ $category->name }}">	
													{{ $category->name }}</a>
											@endif
                            ...
                            <li class="nav-item">
                                <a href="{{ route('front.gallery',$sign) }}" class="nav-link">{{ $langg->lang221 }}</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('front.faq',$sign) }}" class="nav-link">{{ $langg->lang223 }}</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('front.contact',$sign) }}" class="nav-link">{{ $langg->lang20 }}</a>
                            </li>
                        </ul>
  ...
  <footer class="footer-area pt-100 pb-70" style="background: linear-gradient(324deg, #1d31575e, #1a1a1af2),url({{asset('assets/images/'.$gs->contact_icon)}})">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-footer-widget">
                        <h2>
                            <a href="{{ route('front.index',$sign) }}"><img src="{{asset('assets/images/'.$gs->logo_ar)}}" alt=""></a>
                        </h2>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-footer-widget">
                        ...
                        @foreach (App\Models\Blog::orderBy('created_at', 'desc')->limit(3)->get() as $blog)
                            <article class="item">
                                <a href="{{ route('front.blogshow',['id' => $blog->id,'lang'=> $sign]) }}" class="thumb">
                                    <span class="fullimage bg1" role="img" style="background-image: url({{ asset('assets/images/blogs/'.$blog->photo) }});"></span>
                                </a>
                                <div class="info">
                                    <span><a href="{{ route('front.blogshow',['id' => $blog->id,'lang'=> $sign]) }}">{{ date('M d - Y',(strtotime($blog->created_at))) }}</a></span>
                                    <h4><a href="{{ route('front.blogshow',['id' => $blog->id,'lang'=> $sign]) }}"> @if($langg->rtl == 1)
                        ...
                        <ul class="footer-information">
                          ...
                          @if(App\Models\Socialsetting::find(1)->f_status == 1)              
                            <li>
                                ...
                                <span><a href="{{ App\Models\Socialsetting::find(1)->facebook }}"> Facebook</a></span>
                            </li>
                            @endif 
                            @if(App\Models\Socialsetting::find(1)->t_status == 1)          
                            <li>
                                <i class="fab fa-twitter"></i>
                                <span><a href="{{ App\Models\Socialsetting::find(1)->twitter }}"> Twitter</a></span>
                            </li>
                            @endif 
                            @if(App\Models\Socialsetting::find(1)->l_status == 1)
                            <li>
                                <i class="fab fa-linkedin"></i>
                                <span><a href="{{ App\Models\Socialsetting::find(1)->linkedin }}"> linkedin</a></span>
                            </li>
                            @endif
                            @if(App\Models\Socialsetting::find(1)->i_status == 1)
                            <li>
                                <i class="fab fa-instagram"></i>
                                <span><a href="{{ App\Models\Socialsetting::find(1)->instagram }}"> instagram</a></span>
                            </li>
                            @endif
                        </ul>
                    </div>
...
@if(!empty($ps->w_phone))
<li>
<a class="entypo-evernote pulse" href="{{$ps->w_phone}}"><i class="fab fa-whatsapp"></i><span>WhatsApp</span></a>
</li>
@endif
</ul>
