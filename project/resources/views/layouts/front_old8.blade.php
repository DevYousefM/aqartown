                       ...
                       <nav id="navigation" class="navigation navigation-landscape">
                           ...
                           <div class="nav-menus-wrapper" style="transition-property: none;">
                               <ul class="nav-menu">
                                   ...
                                   <li class="active"><a href="{{ route('front.products',$sign) }}">{{ $langg->lang16 }}<span
                                    ...
                                    <li><a class="active" href="{{ route('front.product2',['slug' => $about_us->slug, 'lang' => $sign]) }}">@if($langg->rtl == 1)
...
@endif </a></li>
                                 @endforeach
                                   ...
                                   <li><a href="#">{{ $langg->lang18 }}<span class="submenu-indicator"></span></a>
                                    ...
                                    <li><a class="active" href="  @if($langg->rtl == 1)
                                                    {{ route('front.category',['category' => $category->slug_ar, 'lang' => $sign]) }}
                                                        ...
                                                        @else
                                                                ...
                                                                {{ $category->name }}
                                                                @endif<span
                                                class="{{count($category->subs) > 0 ? 'submenu-indicator' :''}}"></span> </a>
                                   ...
                                   <li><a href="{{ route('front.markets',$sign) }}">{{ $langg->lang11 }}<span class="submenu-indicator"></span></a>
                                       <ul class="nav-dropdown nav-submenu">
                                       @foreach($solutions as $solution)
                                  
                                  <li><a href="{{ route('front.markets_details',['lang'=>$sign , 'slug' => $solution->slug]) }}"> @if($langg->rtl == 1)
                                ...
                                @endforeach
                                   ...
                                   <li><a href="#">{{ $langg->lang221 }}</span></a>
                                       <ul class="nav-dropdown nav-submenu">
                                           <li><a class="active" href="{{ route('front.support',$sign) }}"> {{ $langg->lang20 }} </a></li>
                                   ...
                                   <li><a href="#">{{ $langg->lang223 }}<span class="submenu-indicator"></span></a>
                                       <ul class="nav-dropdown nav-submenu">
                                           ...
                                           <li><a class="active" href="{{ route('front.video',$sign) }}"> {{ $langg->lang12 }} </a></li>
                                           <li><a class="active" href="{{ route('front.blog',$sign) }}"> {{ $langg->lang13 }} </a></li>
                                       </ul>
                                   </li>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget links-widget ml-100">
                                ...
                                <div class="widget-content">
                                    ...
                                    <li><a  href="{{ route('front.product2',['slug' => $about_us->slug, 'lang' => $sign]) }}">@if($langg->rtl == 1)
...
@endif </a></li>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget links-widget ml-70">
                                ...
                                <div class="widget-content">
                                    <ul class="links clearfix">
                                        <li><a href="{{ route('front.contact',$sign) }}">{{ $langg->lang1 }}</a></li>
                            ...
                            <div class="footer-widget links-widget ml-70">
                                ...
                                <div class="widget-content">
                                    <ul class="links clearfix">
                                        ...
                                        <li><a href="#">{{ $langg->lang3 }}: <a href="tel:{{$ps->phone}}">{{$ps->phone}}</a></a></li>
                                        <li><a href="#">{{ $langg->lang6 }}: <a href="tel:{{$ps->fax}}">{{$ps->fax}}</a></a></li>
                                        <li><a href="#">{{ $langg->lang7 }}: <a href="mailto:{{$ps->email}}">{{$ps->email}}</a></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <!-- ============================ Footer End ================================== -->
                    ...
                    <a href="{{$ps->w_phone}}" target="_blank" class="btn-whatsapp-pulse">
                     ...
                     @if(App\Models\Socialsetting::find(1)->f_status == 1)              
                             ...
                             <a href="{{ App\Models\Socialsetting::find(1)->facebook }}" target="_blank" class="btn-facebook-pulse">   <i class="fab fa-facebook-f"></i> </a>
                          
                            @endif 
                            @if(App\Models\Socialsetting::find(1)->t_status == 1)          
                          
                               
                             <a href="{{ App\Models\Socialsetting::find(1)->twitter }}" target="_blank" class="btn-facebook-pulse" style="bottom: 293px;"> <i class="fab fa-twitter"></i> </a>
                           
                            @endif 
                            @if(App\Models\Socialsetting::find(1)->l_status == 1)
                         
                                
                           <a href="{{ App\Models\Socialsetting::find(1)->linkedin }}" target="_blank" class="btn-facebook-pulse" style="bottom: 238px;"><i class="fab fa-linkedin"></i> </a>
                          
                            @endif
                     
                        
                               @if(App\Models\Socialsetting::find(1)->i_status == 1)    
                               <a href="{{ App\Models\Socialsetting::find(1)->instagram }}" target="_blank" class="btn-instagram-pulse2"> <i class="fab fa-instagram"></i> </a>
