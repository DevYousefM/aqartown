...
<img src="{{asset('assets/images/'.$gs->logo)}}" alt="">
                    ...
                    <div class="topbar-inner d-flex flex-wrap align-items-center justify-content-between w-100">
                        ...
                        <div class="topbar-right d-inline-flex align-items-center flex-wrap">
                            <div class="social-links d-inline-flex">
                                ...
                                <a href="{{ App\Models\Socialsetting::find(1)->twitter }}" title="Twtiiter" target="_blank"><i class="fab fa-twitter"></i></a>
								@endif   @if(App\Models\Socialsetting::find(1)->f_status == 1)
							    <a href="{{ App\Models\Socialsetting::find(1)->facebook }}" title="Facebook" target="_blank"><i class="fab fa-facebook-f"></i></a>
								@endif  @if(App\Models\Socialsetting::find(1)->ystatus == 1)
							    <a href="{{ App\Models\Socialsetting::find(1)->youtube }}" title="Youtube" target="_blank"><i class="fab fa-youtube"></i></a>
								@endif @if(App\Models\Socialsetting::find(1)->l_status == 1)
							    <a href="{{ App\Models\Socialsetting::find(1)->linkedin }}" title="Linkedin" target="_blank"><i class="fab fa-linkedin-in"></i></a>
								@endif
						    </div>
                        ...
                        <nav class="d-flex flex-wrap align-items-center justify-content-between w-100">
                            <div class="header-left" style="margin-right: 142px;">
                                <ul class="mb-0 list-unstyled d-inline-flex">
                                    <li class="active"><a href="{{ route('front.index',$sign) }}" title="">{{ $langg->lang17 }}</a>
                                    ...
                                    <li class="menu-item-has-children"><a href="javascript:void(0);" title="">{{ $langg->lang11 }}</a>
                                    ...
                                    <li class="menu-item-has-children"><a href="javascript:void(0);" title=""><a >{{ $langg->lang222 }}</a>
                                        <ul class="mb-0 list-unstyled">

                                            <li><a href="{{ route('front.gallery',$sign) }}" title="">{{ $langg->lang221 }}</a></li>
                                            <li><a href="{{ route('front.video',$sign) }}" title="">{{ $langg->lang223 }}</a></li>
                                        </ul>
                                    </li>
							...
							@if(!empty($ps->phone))    <div class="header-contact position-relative text-color1"><i class="flaticon-telephone thm-clr position-absolute"></i><a href="tel:{{$ps->phone}}">{{$ps->phone}}</a></div>@endif
                                <a class="thm-btn v2 thm-bg brd-rd5 d-inline-block position-relative overflow-hidden" href="{{ route('front.contact',$sign) }}" title=""><i class="flaticon-calendar"></i>{{ $langg->lang12 }}</a>
                            </div>
                        </nav>
                    </div>
                </div>
        ...
        <div class="rspn-hdr">
            <div class="rspn-mdbr">
				...
				@if(App\Models\Socialsetting::find(1)->t_status == 1)
                    <a class="twitter-hvr" href="{{ App\Models\Socialsetting::find(1)->twitter }}" title="Twtiiter" target="_blank"><i class="fab fa-twitter"></i></a>
					@endif     @if(App\Models\Socialsetting::find(1)->f_status == 1)
				    <a class="facebook-hvr" href="{{ App\Models\Socialsetting::find(1)->facebook }}" title="Facebook" target="_blank"><i class="fab fa-facebook-f"></i></a>
					@endif   @if(App\Models\Socialsetting::find(1)->ystatus == 1)
				    <a class="youtube-hvr" href="{{ App\Models\Socialsetting::find(1)->youtube }}" title="Youtube" target="_blank"><i class="fab fa-youtube"></i></a>
					@endif @if(App\Models\Socialsetting::find(1)->l_status == 1)
				    <a class="linkedin-hvr" href="{{ App\Models\Socialsetting::find(1)->linkedin }}" title="Linkedin" target="_blank"><i class="fab fa-linkedin-in"></i></a>
					@endif
			    </div>
            ...
            <div class="lg-mn">
                ...
                margin-bottom: -100px;
            ">
                    <h1 class="mb-0 d-block"><a href="{{ route('front.index',$sign) }}" title="{{ $langg->lang17 }}"><img src="{{asset('assets/images/'.$gs->logo)}}" alt="Logo"></a></h1>
                </div>
                <div class="rspn-cnt">
            ...
            <div class="rsnp-mnu">
                ...
                <ul class="mb-0 list-unstyled w-100">
                                    ...
                                    <li class="active-parent"><a href="{{ route('front.index',$sign) }}" title="">{{ $langg->lang17 }}
  ...
  <footer>
                <div class="w-100 style2 pt-90 dark-layer opc9 pb-130 position-relative">
                    <div class="fixed-bg" style="background-image: url({{asset('assets/images/'.$gs->feature_icon)}});"></div>
                    <div class="container">
                        <div class="footer-data w-100">
                            <div class="row justify-content-between mrg30">
                                <div class="col-md-6 col-sm-6 col-lg-3">
                                    <div class="widget-box v2 w-100">
                                        <h4 class="widget-title2 position-relative" style="
                                        margin-right: 41px;
                                    "><i class="flaticon-idea thm-clr position-absolute"></i>{{ $langg->lang13 }}</h4>
                                        <ul class="contact-info-list mb-0 list-unstyled w-100">
										@if(!empty($ps->phone)) <li><span>{{ $langg->lang48 }}:</span>  <a href="tel:{{$ps->phone}}">  {{$ps->phone}}</a></li> @endif
                                        @if(!empty($ps->email))    <li><span>{{ $langg->lang49 }}:</span>   <a href="mailto:{{$ps->email}}" title=""><span class="__cf_email__" data-cfemail="afc6c1c9c0efcad7cec2dfc3ca81ccc0c2"> {{$ps->email}}</span></a></li>@endif
                                ...
                                <div class="col-md-6 col-sm-6 col-lg-3">
                                    <div class="widget-box v2 w-100">
                                        <h4 class="widget-title2 position-relative"><i class="flaticon-idea thm-clr position-absolute"></i>{{ $langg->lang11 }}</h4>
                                        <ul class="mb-0 list-unstyled w-100">
										...
										@if(App\Models\Socialsetting::find(1)->t_status == 1)
                                            <a class="rounded-circle twitter-hvr" href="{{ App\Models\Socialsetting::find(1)->twitter }}" title="Twtiiter" target="_blank"><i class="fab fa-twitter"></i></a>
											@endif    @if(App\Models\Socialsetting::find(1)->f_status == 1)
										    <a class="rounded-circle facebook-hvr" href="{{ App\Models\Socialsetting::find(1)->facebook }}" title="Facebook" target="_blank"><i class="fab fa-facebook-f"></i></a>
											@endif  @if(App\Models\Socialsetting::find(1)->ystatus == 1)
										    <a class="rounded-circle youtube-hvr" href="{{ App\Models\Socialsetting::find(1)->youtube }}" title="Youtube" target="_blank"><i class="fab fa-youtube"></i></a>
											@endif @if(App\Models\Socialsetting::find(1)->l_status == 1)
									        <a class="rounded-circle linkedin-hvr" href="{{ App\Models\Socialsetting::find(1)->linkedin }}" title="Linkedin" target="_blank"><i class="fab fa-linkedin-in"></i></a>
											@endif
									    </div>
                                    </div>
                                </div>
                                <div class="col-md-7 col-sm-7 col-lg-4">
                                    <div class="widget-box v2 w-100">
                                        <h4 class="widget-title2 position-relative"><i class="flaticon-idea thm-clr position-absolute"></i>{{ $langg->lang220 }}</h4>
                ...
                <div class="container">
                    <div class="bottom-bar-inner d-flex flex-wrap align-items-center justify-content-center w-100">
                        ...
                        <div class="copyright-links d-inline-flex flex-wrap align-items-center justify-content-between">
                            <p class="mb-0"><a href="{{ route('front.index',$sign) }}" title="Neurology">@if($langg->rtl == 1)
                    {!! $gs->copyright_ar !!}
                @else
                    {!! $gs->copyright !!}
                @endif</p>
