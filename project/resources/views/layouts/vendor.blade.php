	...
	<body>
		<div class="page">
			<div class="page-main">
              ...
              <img src="{{asset('assets/')}}/images/user-i.png" alt="">
              @else
              <img src="{{asset('assets/')}}/images/user-i.png" alt="">
              @endif
											</div>
											...
											<div class="dropdownmenu-wrapper">
													<ul>
														<h5>{{ $langg->lang431 }}</h5>
															...
															<li>
																<a href="{{ route('user-dashboard',['lang' => $sign ]) }}"><i class="fas fa-sign-in-alt"></i> {{ $langg->lang17 }}</a>
															</li>
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							...
							<li>
								<a href="{{ route('vendor-dashboard',['lang' => $sign ]) }}" class="wave-effect active"><i class="fa fa-home mr-2"></i>{{ $langg->lang441 }}</a>
							</li>
							...
							<li>
								...
								<ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
									<li>
										<a href="{{ route('vendor-prod-physical-create',['lang' => $sign ]) }}"><span>{{ $langg->lang518 }}</span></a>
									</li>
									<li>
										<a href="{{ route('vendor-prod-index',['lang' => $sign ]) }}"><span> {{ $langg->lang443 }}</span></a>
									</li>
