...
-->
    ...
    <script src="{{ asset('assets/aqar/') }}/js/bootstrap.min.js"></script>

    <script src="{{ asset('assets/aqar/') }}/js/wow-animate.min.js"></script>

    <script src="{{ asset('assets/aqar/') }}/js/isotope.pkgd.min.js"></script>

    <script src="{{ asset('assets/aqar/') }}/js/jquery.magnific-popup.min.js"></script>

    <script src="{{ asset('assets/aqar/') }}/js/owl.carousel.min.js"></script>

    <script src="{{ asset('assets/aqar/') }}/js/select2.min.js"></script>

    <script src="{{ asset('assets/aqar/') }}/js/swiper.min.js"></script>

    <script src="{{ asset('assets/aqar/') }}/js/main.js"></script>
    <script>
