...
<script type="application/ld+json">
  {
    ...
    <!-- bootstarp -->
    <link rel="stylesheet" href="{{asset('assets/beautifulhouse/')}}/css/vendors/bootstrap.min.css">

    <!-- Fancybox -->
    <link rel="stylesheet" href="{{asset('assets/beautifulhouse/')}}/css/vendors/jquery.fancybox.min.css">
    <link rel="stylesheet" href="{{asset('assets/beautifulhouse/')}}/css/linearicons.css" />
    <!-- animate.css file -->
    <link rel="stylesheet" href="{{asset('assets/beautifulhouse/')}}/css/vendors/animate.css">

    <!-- Swiper -->
    <link rel="stylesheet" href="{{asset('assets/beautifulhouse/')}}/css/vendors/swiper.min.css">
    <link rel="stylesheet" href="{{asset('assets/beautifulhouse/')}}/css/lightgallery.css" />
    <!-- vegas -->
    <link rel="stylesheet" href="{{asset('assets/beautifulhouse/')}}/css/vendors/vegas.min.css">
    <!-- fontAwesome -->
    <link rel="stylesheet" href="{{asset('assets/beautifulhouse/')}}/css/vendors/all.min.css">
    ...
    <!-- main-RTL -->
    <link rel="stylesheet" href="{{asset('assets/beautifulhouse/')}}/css/index.css">
                        ...
                        <div class="list-js info-list"><i class="fas fa-times close-icon"></i>
                            <div class="info-list-inner">
                                <div class="info info-panel-logo">
                                    <div class="logo"><img class="logo-img light-logo" src="{{asset('assets/images/'.$gs->logo)}}"
                                                           alt="logo"></div>
                                ...
                                <div class="info">
                                    ...
                                    <div class="info-text"><span class="text">  {{$langg->rtl == 1 ? $ps->street_ar  : $ps->street }}    </span><span class="sub-text">  {{$langg->rtl == 1 ? $ps->street_ar  : $ps->street }}      </span></div>
                                </div>
                                <div class="info">
                                    <div class="info-icon"><i class="far fa-envelope  icon"></i></div>
                                    <div class="info-text"><span class="text ">{{$ps->email}}</span><a class="sub-text info-link"
                                                                                                      href="mailto:{{$ps->email}}">{{$ps->email}}</a></div>
                                </div>
                                <div class="info">
                                    <div class="info-icon"> <i class="fas fa-mobile-alt  icon"></i></div>
                                    <div class="info-text"><span class="text ">{{$ps->phone}}</span><a class="sub-text info-link"
                                ...
                                <div class="sc-wrapper dir-row sc-flat">
                                    <ul class="sc-list">
                                        ...
                                        <li class="sc-item " title="Facebook">
                                            <a class="sc-link" href="{{ App\Models\Socialsetting::find(1)->facebook }}"><i
                                                        class="fab fa-facebook-f sc-icon"></i></a>
                                        </li>
                                        @endif
                                            @if(App\Models\Socialsetting::find(1)->y_status == 1)
                                            <li class="sc-item " title="youtube"><a class="sc-link" href="{{ App\Models\Socialsetting::find(1)->youtube }}"><i
                                                        class="fab fa-youtube sc-icon"></i></a></li>
                                            @endif
                                        @if(App\Models\Socialsetting::find(1)->i_status == 1)
                                        <li class="sc-item " title="instagram"><a class="sc-link" href="{{ App\Models\Socialsetting::find(1)->instagram }}"><i
                                                        class="fab fa-instagram sc-icon"></i></a></li>
                                            @endif
                                            @if(App\Models\Socialsetting::find(1)->t_status == 1)
                                        <li class="sc-item " title="twitter"><a class="sc-link" href="{{ App\Models\Socialsetting::find(1)->twitter }}"><i
        ...
        <div class="bar-bottom">
            <div class="container">
                <nav class="menu-navbar">
                    <div class="header-logo"><a class="logo-link" href="{{ route('front.index',$sign) }}"><img class="logo-img light-logo"
                                                                                src="{{asset('assets/images/'.$gs->logo)}}" alt="logo" /><img class="logo-img  dark-logo"
                                                                                                                                    src="{{asset('assets/images/'.$gs->logo)}}" alt="logo" /></a></div>
                    <div class="links menu-wrapper ">
                        <ul class="list-js links-list">
                            <li class="menu-item"><a class="menu-link" href="{{ route('front.index',$sign) }}">{{ $langg->lang17 }}</a>

                            <li class="menu-item"><a class="menu-link" href="{{ route('front.about',$sign) }}"> {{ $langg->lang16 }}</a></li>
                            <li class="menu-item"><a class="menu-link" href="{{ route('front.latestwork',$sign) }}">اعمال السابقة</a></li>

                            @foreach($categories as $category)
                            <li class="menu-item has-sub-menu"><a class="menu-link  " href="@if($langg->rtl == 1)
                           ...
                           {{-- <li class="menu-item has-sub-menu"><a class="menu-link  " href="#0">الدريسينج رووم<i
                            ...
                            <li class="menu-item has-sub-menu"><a class="menu-link  " href="#0">{{ $langg->lang223 }}<i
                                            class="fas fa-chevron-down down-Arrow-icon"> </i></a>
                                <ul class="sub-menu ">
                                    <li class="menu-item sub-menu-item"><a class="menu-link sub-menu-link  "
                            ...
                            <li class="menu-item"><a class="menu-link  " href="{{ route('front.contact',$sign) }}">{{ $langg->lang20 }}   </a></li>
                        </ul>
                    </div>
    ...
    <div class="container">
        <div class="row footer-cols">
            <div class="col-12 col-md-8 col-lg-4  footer-col wow fadeInUp " data-wow-delay="0.3s"><img
                        class="img-fluid footer-logo" src="{{asset('assets/images/'.$gs->logo)}}" alt="logo" />
                <div class="footer-col-content-wrapper">
                    <p class="footer-text-about-us "> @if($langg->rtl == 1)
                            {!! $gs->footer_ar !!}
                        @else
                            {!! $gs->footer !!}
                        @endif
          ...
          {{--  <div class="col-12 col-md-6 col-lg-2  footer-col wow fadeInUp " data-wow-delay="0.5s">
            ...
            <div class="col-12 col-md-6 col-lg-2 footer-col wow fadeInUp " data-wow-delay=".7s">
                <h2 class=" footer-col-title    ">@if($langg->rtl == 1)
                ...
                <div class="footer-col-content-wrapper">
                 ...
                 {{--   <div class="contact-info-card"><i class="fas fa-globe-africa icon"></i><a class="text-lowercase  info"
                    ...
                    <div class="contact-info-card"><i class="fas fa-map-marker-alt icon"></i><span
                                class="text-lowercase  info"> {{$langg->rtl == 1 ? $ps->street_ar  : $ps->street }}     </span></div>
...
<!-- end all footer -->
    ...
    <!--     JQuery     -->
    <script src="{{asset('assets/beautifulhouse/')}}/js/vendors/jquery-3.4.1.min.js"></script>

    <!--     bootstrap     -->
    <script src="{{asset('assets/beautifulhouse/')}}/js/vendors/bootstrap.bundle.min.js"></script>

    <!--     fancybox     -->
    <script src="{{asset('assets/beautifulhouse/')}}/js/vendors/jquery.fancybox.min.js"></script>

    <!--     countTo     -->
    <script src="{{asset('assets/beautifulhouse/')}}/js/vendors/jquery.countTo.js"></script>

    <!--     wow     -->
    <script src="{{asset('assets/beautifulhouse/')}}/js/vendors/wow.min.js"></script>

    <!--     swiper     -->
    <script src="{{asset('assets/beautifulhouse/')}}/js/vendors/swiper.min.js"></script>
<script src="{{asset('assets/beautifulhouse/')}}/js/vendors/vegas.min.js"></script>
    <!--     Vanilla-tilt     -->
    <script src="{{asset('assets/beautifulhouse/')}}/js/vendors/vanilla-tilt.min.js"></script>

    <!--     isotope     -->
    <script src="{{asset('assets/beautifulhouse/')}}/js/vendors/isotope-min.js"></script>
<script src="{{asset('assets/beautifulhouse/')}}/js/vendors/lightgallery.js"></script>

<script src="{{asset('assets/beautifulhouse/')}}/js/vendors/lg-thumbnail.js"></script>
    <!--     ajaxchimp     -->
    <script src="{{asset('assets/beautifulhouse/')}}/js/vendors/jquery.ajaxchimp.min.js"></script>

    <!--     main     -->
    <script src="{{asset('assets/beautifulhouse/')}}/js/main.js"></script>
