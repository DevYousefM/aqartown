			...
			<div class="popup__wrapBody">
				<div class="popup__body">
					<div class="popup__content formBlock">
						...
						<h5 class="popup__title text-center mx-auto">Enter your contact details and a convenient time to call
						</h5>
						...
						<form id="popupForm" class="chimeForm d-flex flex-column" name="chimeform"
							...
							<input type="text" name="popup-invisible" class="chimeForm__field d-none text-center reset w-100">
							<div class="chimeForm__wrapButtons d-flex justify-content-between">
								<button id="call-now" type="button" class="chimeForm__button chimeForm__field">Call now</button>
								<button id="call-time" type="button" class="chimeForm__button chimeForm__field active">Call on
									time</button>
							</div>
							<input class="chimeForm__hidden" type="text" name="call-now" value="Call now">
							<input class="text-center chimeForm__field chimeForm__dateTime reset" type="text" name="date-time"
								placeholder="For example: January 21 at 14:00">
					...
					<div class="popup__content thankBlock popup__content-close">
						...
						<div class="popup__wrap">
							<h3 class="popup__thanks mx-auto text-center">Thank you, we have accepted your application!</h3>
			...
			<div class="container">
				<div class="row">
					<div class="col top-panel align-items-center d-flex justify-content-between">
						<a href="{{ route('front.index',$sign) }}" class="logo"><img src="{{asset('assets/images/'.$gs->logo)}}" alt="Logo"></a>
						<nav id="topmenu" class="topmenu d-flex">
							...
							<ul class="topmenu__list">
								<li class="topmenu__listItem active">
									<a href="{{ route('front.index',$sign) }}" class="topmenu__link">{{ $langg->lang17 }}</a>
								</li>
								<li class="topmenu__listItem">
									<a href="{{ route('front.about',$sign) }}" class="topmenu__link">{{ $langg->lang16 }}</a>
								</li>
								<li class="topmenu__listItem">
									<a href="#" class="topmenu__link"> {{ $langg->lang11 }} <span class="fal fa-angle-down topmenu__arrow"></spam></a>
							...
							@endif
								...
								<li class="topmenu__listItem">
									<a href="{{ route('front.team',$sign) }}" class="topmenu__link">{{ $langg->lang10 }}</a>
								</li>
								<li class="topmenu__listItem">
									<a href="{{ route('front.faq',$sign) }}" class="topmenu__link">{{ $langg->lang19 }}</a>
								</li>
								<li class="topmenu__listItem">
									<a href="{{ route('front.gallery',$sign) }}" class="topmenu__link">{{ $langg->lang221 }}</a>
								</li>
							
								<li class="topmenu__listItem">
									<a href="{{ route('front.contact',$sign) }}" class="topmenu__link">{{ $langg->lang20 }}</a>
								</li>
							</ul>
						</nav>
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-md-4 col-12 d-flex justify-content-center justify-content-md-start">
						<a class="footer__logo logo" href="{{ route('front.index',$sign) }}"><img src="{{asset('assets/images/'.$gs->logo)}}" alt="logo"></a>
					</div>
