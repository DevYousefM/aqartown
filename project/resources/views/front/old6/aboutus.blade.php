                    ...
                    <div class="sidebar-widget category-widget">
                        ...
                        <div class="widget-content">
                            <ul class="category-list clearfix"> 
                                ...
                                <li>
                                    <h5><a href="{{ route('front.categories',$sign) }}">  {{ $langg->lang223 }} </a></h5>
...
<section class="features-area text-right pb-70" style="background-color: #f7fcfe;">
    <div class="container-fluid">
      ...
      @foreach($counters as $key=>$counter)
        <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3" data-aos="fade-down-left" data-aos-duration="1500">
            <div class="single-features-2">
                ...
                <div class="card mb-3">
                    <div class="row g-0">
                      ...
                      <div class="col-md-8">
                        <div class="card-body">
                          <h2 class="card-title">{{$langg->rtl == 1 ? $counter->title_ar : $counter->title}}</h2>
                          <p class="card-text">{{$langg->rtl == 1 ? $counter->subtitle_ar : $counter->subtitle}}</p>
                        </div>
                      </div>
                    </div>
                  </div>
