...
@section('content')
    ...
    <section class="breadcrumb-section" style="background-image: url({{asset('assets/images/'.$gs->discount_icon)}});">
        <div class="container">
                ...
                <div class="form-wrapper" id="contact">
                    ...
                    {{csrf_field()}}
                      <div class="form-group w-100">
                        ...
                        <div class="form-div">
                            <input type="text" name="name" value="" class="form-control fname" placeholder=" {{ $langg->lang43 }} *" required="required">
                            <div class="thin-line"></div>
                        </div>
                     
                        <div class="form-div">
                            <input type="text" name="phone" value="" placeholder="{{ $langg->lang44 }} *" required="required">
                            <div class="thin-line"></div>
                        </div>
                        <div class="form-div">
                            <input type="text" name="subject" value="" id="" placeholder="{{ $langg->lang45 }}*" required="required">
                            <div class="thin-line"></div>
                        </div>
                        <div class="form-div">
