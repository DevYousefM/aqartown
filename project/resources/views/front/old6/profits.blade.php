...
@php 
  ...
  <section class="breadcrumb-section" style="background-image: url({{asset('assets/images/'.$gs->contact_icon)}});">
    <div class="container">
    ...
    <div class="home-gallery-section">
        ...
        <div class="gallery-layout">
            ...
            @foreach($reviews as $review)
                     <a href="{{asset('assets/images/reviews/'.$review->photo)}}" data-aos="zoom-in" data-aos-duration="1500">
