                ...
                <div class="slide-item" style="background-image: url({{asset('/assets/images/sliders/'.$galss)}});">
                    <div class="container">
                        ...
                        @if(!empty($slide->subtitle_text) || !empty($slide->subtitle_text_ar) )  
                             <div class="title wow fadeInUp" data-wow-delay="250ms">{{$langg->rtl == 1 ? $slide->subtitle_text_ar :   $slide->subtitle_text}}</div>
                         @endif   

                            <h2 class="wow fadeInUp" data-wow-delay="500ms">{{$langg->rtl == 1 ? $slide->title_text_ar :   $slide->title_text}}</h2>
                        ...
                        <div class="department-box">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3><i class="fad fa-syringe"></i>@if($langg->rtl == 1)
        ...
        <section class="gallery-section">
            <div class="container">
                ...
                @foreach($services->take(6) as $key=>$service)
                    <div class="project-block col-lg-4 col-md-6 col-sm-12"@if($key == 0 )
                                ...
                                <div class="overlay-box">
                                    <div class="overlay-inner">
                                        <div class="overlay-content">
                                            ...
                                            <h3><a href="#">{{$langg->rtl == 1 ? $service->name_ar  : $service->name }}</a></h3>
                                            <a class="plus" href="{{asset('assets/images/services/'.$service->photo)}}" data-fancybox="gallery-1"
