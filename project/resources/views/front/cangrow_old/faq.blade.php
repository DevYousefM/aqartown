		  ...
		  <section id="faq" class="faq position-relative overflow-hidden">
			 <div class="container">
				...
				<div class="row position-relative">
				   <div class="col-lg-6">
					  <p data-aos="fade">  @if($langg->rtl == 1)
				   ...
				   <div class="col-lg-6">
					  <div class="faq__BlockImage overflow-hidden position-relative" data-aos="fade">
						 <div class="sk-spinner sk-spinner-pulse"></div>
						   <img class="faq__image b-lazy"
							data-src="{{asset('assets/images/'.$gs->new_icon)}}"
...
padding-right: 35px;">
						 ...
						 <div class="accordion__item js-accordion-item overflow-hidden" data-aos="fade-up"
							data-aos-delay="200">
							<div class="accordion-header js-accordion-header">{{$langg->rtl == 1 ? $fq->title_ar  : $fq->title}}
							</div>
			 ...
			 <img class="faq__illustration position-absolute" src="{{asset('assets/cangrow/images/svg/faq-illustration.svg')}}" alt="FAQ Illustration">
		  </section>
			 ...
			 <div style="">
				...
				<div class="col-md-6">
				   <div class="subscribe__BlockImage overflow-hidden position-relative" data-aos="fade"
					  data-aos-delay="300">
					  <div class="sk-spinner sk-spinner-pulse"></div>
					  <img class="subscribe__image position-absolute b-lazy" data-src="{{asset('assets/images/'.$gs->trending_icon)}}"
						 src="{{asset('assets/images/'.$gs->trending_icon)}}" alt="">
				   </div>
				</div>
				<div class="col-md-6 align-items-center d-flex">
							
				   <form  class="subscribe__form d-flex w-100" action="{{route('front.subscribe')}}" id="subscribeform" name="subscribeForm" method="POST">
				   {{csrf_field()}}
					  <input type="email" name="email" class="subscribe__field h-100" placeholder="{{ $langg->lang741 }}" required="">
					  <button type="submit" id="sub-btn" class="subscribe__submit h-100">{{ $langg->lang742 }}</button>
				   </form>
				</div>
			 </div>
		  </div>
