			...
			<section id="team" class="ourTeam">
				...
				<div class="container">
					...
					@foreach($our_teams as $k=> $data)
						<div class="col-md-4">
							<div class="ourTeam__worker d-flex flex-column h-100 justify-content-between" data-aos="zoom-out"
								data-aos-delay="100">
								<div class="sk-spinner sk-spinner-pulse"></div>
								<img class="ourTeam__image position-absolute h-100 w-100 b-lazy" data-src="{{asset('assets/images/services/'.$data->photo)}}"
								...
								<div class="ourTeam__workerContent">
									<h3 class="ourTeam__name text-center">@if($langg->rtl == 1)
									...
									{!! $data->name !!}
									@endif</h3>
									<p class="ourTeam__position text-center">@if($langg->rtl == 1)
									...
									@if(!empty($data->facebook ))	<li class="ourTeam__socialItem">
											<a href="{!! $data->facebook !!}" class="ourTeam__socialIink ourTeam__socialIink-facebook">
										...
										<li class="ourTeam__socialItem">
											<a href="{!! $data->linkedin !!}" class="ourTeam__socialIink ourTeam__socialIink-instagram">
												<svg viewBox="0 0 24 24">
													...
													<path
														...
														transform="translate(0 -0.001)" fill="currentColor" />
													<circle cx="1.439" cy="1.439" r="1.439" transform="translate(16.967 4.155)"
														fill="currentColor" />
												</svg>
											</a>
										</li>
										...
										<li class="ourTeam__socialItem">
											<a href="{!! $data->twiter !!}" class="ourTeam__socialIink ourTeam__socialIink-twitter">
