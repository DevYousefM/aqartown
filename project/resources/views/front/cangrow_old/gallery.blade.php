   ...
   @endphp
      <main class="main page page__portfolio">
         <div class="page__header container">
            <div class="row">
               <div class="col-12">
                  <h2 class="page__above-title text-center" data-aos="fade-down" data-aos-delay="700">{{ $langg->lang15 }}</h2>
               ...
               <div class="row">
                  <div class="col">
                     <ul class="portfolio__list-filter d-flex flex-wrap justify-content-center">
                        ...
                        <li class="portfolio__list-filter-item" data-filter="{{$data->id}}" data-aos="fade-left"
                           data-aos-delay="900">  @if($langg->rtl == 1)
                  ...
                  <div class="col-sm-6 col-lg-3 portfolio__column {{$data->country_id}}">
                     <div class="portfolio__work" data-aos="fade-up" data-aos-delay="600">
                        <div class="portfolio__wrap-icons">
                           <a class="portfolio__work-zoom-image" href="{{asset('assets/images/gallery/'.$data->photo)}}">
                        ...
                        <div class="portfolio__work-name-desc">
                           <h3 class="portfolio__work-name text-center">@if($langg->rtl == 1)
...
@endif</h3>
                           <p class="portfolio__work-desc text-center">@if($langg->rtl == 1)
