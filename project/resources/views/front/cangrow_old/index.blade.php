		...
		<div id="firstScreen" class="wrap-firstScreen overflow-hidden position-relative">
			<div class="firstScreen container">
				<div class="row align-items-center h-100">
					<div class="col-lg-5">
					@if(!empty($sliders[0]->subtitle_text) || !empty($sliders[0]->subtitle_text_ar) ) <h2 class="firstScreen__aboveTitle" data-aos="fade-up">{{$langg->rtl == 1 ? $sliders[0]->subtitle_text_ar :   $sliders[0]->subtitle_text}}</h2> @endif
							@if(!empty($sliders[0]->title_text) || !empty($sliders[0]->title_text_ar) )  	<h1 class="firstScreen__title" data-aos="fade-up" data-aos-delay="100">{{$langg->rtl == 1 ? $sliders[0]->title_text_ar :   $sliders[0]->title_text}}</h1> @endif
						@if(!empty($sliders[0]->details_text) || !empty($sliders[0]->details_text_ar) )  		<p class="firstScreen__text" data-aos="fade-up" data-aos-delay="200">{{$langg->rtl == 1 ? $sliders[0]->details_text_ar :   $sliders[0]->details_text}}</p> @endif
					...
					<div class="col-7 h-100 align-items-center d-none d-lg-flex fs-ilustratio-col" data-aos="fade-in"
						data-aos-delay="500">
						<img src="{{asset('/assets/images/sliders/'.$sliders[0]->photo)}}" style="max-width: 1000px;" alt="">
					</div>
				</div>
				<button class="firstScreen__btnDown position-absolute" type="button" data-aos="fade-up" data-aos-delay="500"
					data-aos-offset="0">
			...
			<section id="about" class="about position-relative">
				...
				<div class="container about__content">
					<div class="row align-items-center">
						...
						<img class="img-fluid w-100" src="{{asset('assets/images/brands/'.$about_us->photo)}}" alt="{{$about_us->name}}">
						</div>
						<div class="col-xl-6 content-column">
							<h3 class="about__title" data-aos="fade-in" data-aos-delay="100"> @if($langg->rtl == 1)

{{ $about_us->title_ar }}
@else

{{ $about_us->title }}
@endif<br>@if($langg->rtl == 1)
...
{{ $about_us->name }}
@endif</h3>
							<p class="about__text" data-aos="fade-in" data-aos-delay="200">@if($langg->rtl == 1)
				...
				<div class="wrap-about__bottomInfo overflow-hidden position-relative">
					<img class="about__bottomInfoBG position-absolute" src="{{asset('assets/cangrow/images/svg/about-bottom-illustration.svg')}}"
					...
					<div class="container about__bottomInfo align-items-end d-flex">
						<div class="row">
							...
							<div class="col-xl-2 col-sm-3 about__bottomInfoItem" data-aos="fade-in" data-aos-delay="300">
				...
				<div class="container">
					<div class="row">
						<div class="col">
							...
							<p class="section-under-title text-center" data-aos="fade-in" data-aos-delay="200">{{ $langg->lang1 }}</p>
						</div>
					</div>
					<div class="row position-relative">
						...
						<div class="col-md-6 @if($key == 0) position-relative @endif"@if($key % 2) data-aos="fade-right"  @else data-aos="fade-left"  @endif>
							<img class="works__illustration position-absolute" src="{{asset('assets/images/gallery/'.$work->photo)}}"
							...
							@if($key == 0)	<img class="works__arrowOne position-absolute" src="{{asset('assets/cangrow/images/svg/works-01.svg')}}" alt="Arrow One">@endif
							@if($key == 1)	<img class="works__arrowTwo position-absolute" src="{{asset('assets/cangrow/images/svg/works-02.svg')}}" alt="Arrow Two">@endif
						</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							...
							<a class="effectiveMarketing__link" href="{{ route('front.about',$sign) }}" style="border: 1px solid #056839;">{{ $langg->lang12 }}</a>
						</div>
							...
							<div class="effectiveMarketing__progresBars">
							 ...
							 @foreach($title as $key => $data1)
								...
								<div class="effectiveMarketing__progresBar">
									<h4 class="effectiveMarketing__progresBarName text-uppercase">{{$langg->rtl == 1 ? $title_ar[$key] : $title[$key]}}</h4>
									<div class="effectiveMarketing__progresBarWrapFilling">
										<div class="effectiveMarketing__progresBarFilling width-zero data-width" data-width="{{$value[$key]}}%">
					...
					@foreach($counters as $counter)
						<div class="col-6 col-sm-3 text-center">
							<div class="counters__counter">
								...
								<p class="counters__text">{{$langg->rtl == 1 ? $counter->title_ar : $counter->title}}</p>
							</div>
						</div>
						@endforeach
					</div>
				</div>
				<img class="counters__illustration-right" src="{{asset('assets/cangrow/images/svg/counters-right.svg')}}"
					alt="Counters Illustration right">
			</div>
	 @endif

			<section class="ourClients">
				<img class="ourClients__bg-clients" src="{{asset('assets/cangrow/images/svg/bg-clients.svg')}}" alt="">
				<div class="container">
					<div class="row">
						<div class="col">
							...
							<div class="ourClients__slider swiper-conteiner overflow-hidden">
								...
								@foreach($partners as $partner)
									<div class="ourClients__slide swiper-slide">
										...
										<img class="swiper-lazy ourClients__image" data-src="{{asset('assets/images/partner/'.$partner->photo)}}"
				...
				<div class="container">
					<div class="row">
						<div class="col">
							...
							<p class="section-under-title text-center" data-aos="fade-in" data-aos-delay="200">{{ $langg->lang4 }}</p>
						</div>
					</div>
					<div class="row">
						<div class="col">
								...
								@foreach($reviews as $review)
									<div class="reviews__slide swiper-slide container">
										<div class="row">
											...
											<div class="col-lg-6" data-aos="fade">
												<h3 class="reviews__name">{{$langg->rtl == 1 ? $review->title_ar : $review->title}}</h3>
												<div class="reviews__review position-relative">
													<img class="reviews__quote reviews__quote-top position-absolute"
														src="{{asset('assets/cangrow/images/svg/quote.svg')}}" alt="Quote">
													<div class="reviews__fullReview close">
													 ...
													 <button type="button" class="reviews__button">
															<span class="reviews__buttonText reviews__buttonRead">Read full
																review</span>
															<span class="reviews__buttonText reviews__buttonCloce">Close full
																review</span>
														</button>	<!-- -->
													</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="subscribe__BlockImage overflow-hidden position-relative" data-aos="fade"
							data-aos-delay="300">
							<div class="sk-spinner sk-spinner-pulse"></div>
							<img class="subscribe__image position-absolute b-lazy" data-src="{{asset('assets/images/'.$gs->big_icon)}}"
								src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" alt="">
						</div>
					</div>
