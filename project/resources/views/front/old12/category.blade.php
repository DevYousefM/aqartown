        ...
        <div class="vegas-slider-content" data-vegas-slide-1="{{asset('assets/images/'.$gs->feature_icon)}}"
          ...
          <div class="row">
            <div class="col-12 hero-text-area ">
              <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">@if(!empty($childcat))
                  @if($langg->rtl == 1)
                    {{ $childcat->name_ar }}
              ...
              <nav aria-label="breadcrumb ">
                <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
                  ...
                  <li class="breadcrumb-item active">@if(!empty($childcat))
                      @if($langg->rtl == 1)
                        {{ $childcat->name_ar }}
          ...
          <div class="row">
              <div class="col-md-6 col-sm-7">
                  <div class="single-product-info">
                      <div class="col-md-12">
                          <h3 class="text-black-1">   @if(!empty($childcat))
                              @if($langg->rtl == 1)
                                {{ $childcat->name_ar }}
    ...
    <section class="portfolio portfolio-slider    mega-section" id="portfolio">
      <div class="container">
        <div class="section-heading center-heading">
          <h2 class="section-title  wow fadeInUp" data-wow-delay=".2s">@if($langg->rtl == 1)
              {{ $cat->name_ar }}
            ...
            @endif <span
                    class='hollow-text'>  </span><span class="title-design-element "></span></h2>
        ...
        <div class="swiper-wrapper ">
          @if(count($cat->subs) > 0)
            ...
            <div class="swiper-slide">
              <div class="item "><a class="portfolio-img-link " href="{{ route('front.category',['category' => $subcat->category->slug_ar, 'subcategory' => $subcat->slug_ar , 'lang' => $sign]) }}">
                  <div class="overlay overlay-color"></div><img class="  portfolio-img img-fluid  "
                                                                src="{{asset('assets/images/subcategories/'.$subcat->photo)}}" alt=" ">
                </a>
                <div class="item-info "><span></span>
                   <h3 class="item-title">@if($langg->rtl == 1)
