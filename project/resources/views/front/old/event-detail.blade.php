...
@section('content')
    ...
    <section><!--assets/images/parallax8.jpg-->
                <div class="w-100 pt-180 pb-180 page-title-wrap text-center black-layer opc5 position-relative">
                    <div class="fixed-bg" style="background-image: url({{ $productt->hover_photo ? filter_var($productt->hover_photo, FILTER_VALIDATE_URL) ? $productt->hover_photo :asset('assets/images/products/'.$productt->hover_photo):asset('assets/images/'.$gs->big_icon) }});"></div>
                    <div class="container">
                        <div class="page-title-inner d-inline-block">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('front.index',$sign)}}" title="">{{ $langg->lang17 }}</a></li>
                                 ...
                                 <li class="breadcrumb-item"><a href=" @if($langg->rtl == 1)
                                     {{route('front.category',['category' => $productt->category->slug_ar ,'lang' => $sign])}}

                                     @else
                                     {{route('front.category',['category' => $productt->category->slug,'lang' => $sign])}}

                                     @endif" title="">  @if($langg->rtl == 1)
                            ...
                            @if(!empty($productt->subcategory))
                                <li class="breadcrumb-item"><a href=" @if($langg->rtl == 1)
                                     {{route('front.category',['category' => $productt->category->slug_ar, 'slug2' => $productt->subcategory->slug_ar ,'lang' => $sign])}}

                                     @else
                                     {{route('front.category',['category' => $productt->category->slug, 'slug2' => $productt->subcategory->slug,'lang' => $sign])}}
                        ...
                        <div class="event-detail w-100">
                            <div class="event-detail-info w-100">
                                ...
                                <div class="event-detail-img position-relative w-100">
                                    <img class="img-fluid w-100" src="{{ $productt->hover_photo ? filter_var($productt->hover_photo, FILTER_VALIDATE_URL) ? $productt->hover_photo :asset('assets/images/products/'.$productt->hover_photo):asset('assets/images/noimage.png') }}"
                                         @if($langg->rtl == 1)
                            ...
                            <div class="event-detail-content position-relative w-100">
                                ...
                                <div class="event-detail-feat position-relative w-100">
                                    ...
                                    <ul class="event-detail-features-list mb-0 list-unstyled w-100">
                                        ...
                                        <li><i class="far fa-calendar-check"></i>{{ $productt->features[$key] }}<span class="d-block">{{ $productt->colors[$key] }}</span></li>
                                        @endforeach
                                    </ul>
                                </div>
                                        ...
                                        <div class="row mrg50">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                <div class="speaker-box position-relative mb-40 w-100 overflow-hidden">
                                                    <img class="img-fluid w-100" src="{{asset('assets/images/speakers/'.$data->photo)}}" alt="Speaker Image 1">
                                                    <div class="speaker-info position-absolute">
                                                        <h3 class="mb-0 text-white"><a href="{{$data->facebook}}">
                                                                ...
                                                                @endif</a></h3>
                                                        <span class="d-block">@if($langg->rtl == 1)
                                                    ...
                                                    <h3 class="mb-0 text-white position-absolute"> @if($langg->rtl == 1)
 ...
 @endif
                                ...
                                <div class="event-detail-getintouch position-relative w-100">
                                    ...
                                    <div class="event-detail-getintouch-inner w-100">
                                        @if(!empty($productt->touch))<p class="mb-0"> {!! $productt->touch !!}</p> @endif
                                            @if(!empty($productt->reg_link))   <a class="thm-btn fill-btn" href="{!! $productt->reg_link !!}" title="">{{$langg->lang232}} <i class="flaticon-trajectory"></i><span></span></a> @endif
                                        <div class="social-links4 mt-20 d-flex flex-wrap">
                                            @if(App\Models\Socialsetting::find(1)->f_status == 1)
                                                <a class="facebook" href="{{ App\Models\Socialsetting::find(1)->facebook }}" title="Facebook" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                            @endif
                                            @if(App\Models\Socialsetting::find(1)->i_status == 1)
                                                <a class="pinterest" href="{{ App\Models\Socialsetting::find(1)->instagram }}" title="instagram" target="_blank"><i class="fab fa-instagram"></i></a>

                                            @endif
                                            @if(App\Models\Socialsetting::find(1)->t_status == 1)
                                                <a class="twitter" href="{{ App\Models\Socialsetting::find(1)->twitter }}" title="Twitter" target="_blank"><i class="fab fa-twitter"></i></a>

                                            @endif
                                            @if(App\Models\Socialsetting::find(1)->ystatus == 1)
                                                <a class="vimeo" href="{{ App\Models\Socialsetting::find(1)->youtube }}" title="youtube" target="_blank"><i class="fab fa-youtube"></i></a>
            ...
            @if(count($productt->category->products()->where('status','=',1)->where('id','!=',$productt->id)->take(3)->get()) > 0)
            <section>
                                ...
                                <div class="col-md-4 col-sm-6 col-lg-4">
                                    <div class="event-grid-box mb-30 w-100">
                                        <div class="event-grid-img w-100 overflow-hidden position-relative">
                                            ...
                                            <a class="thm-btn fill-btn" href="{{ route('front.product', ['slug' => $data->slug , 'lang' => $sign]) }}" title="">Book Now<span></span></a>
                                        </div>
                        ...
                        <div class="sponsors-wrap w-100">
                            <div class="sponsor-caro">
                                ...
                                <div class="text-center w-100">
                                    <a href="javascript:void(0);" title=""><img class="img-fluid d-inline-block" src="{{asset('assets/images/galleries/'.$gal->photo)}}" alt="Sponsor Image 1"></a>
                                </div>
                                @endforeach
                            </div>
                        </div><!-- Sponsors Wrap -->
