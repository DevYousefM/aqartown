                                    ...
                                    <div class="blog-wrap w-100">
                                        ...
                                        <div class="post-style2 list-view d-flex flex-wrap align-items-center mb-50 w-100">
                                            ...
                                            <div class="post-info2 w-100">
                                                <h3 class="mb-0"><a href="{{route('front.blogshow',['id' => $blogg->slug ,'lang' => $sign ])}}" title="">
                                                        @if($langg->rtl == 1)
                                                ...
                                                <div class="post-meta2">
                                                    <span class="post-date thm-clr">{{date('M d,Y', strtotime($blogg->created_at))}}</span>
                                                ...
                                                <div class="post-tags w-100">
                                                    <span class="thm-clr"><i class="fas fa-tag"></i>{{ $langg->lang35 }}:</span>
                                                    @foreach(explode(',', $blogg->tags) as $key => $tag)

                                                    <a href="{{ route('front.blogtags',['slug' => $tag ,'lang' => $sign ]) }}" title="">  {{ $tag }}{{ $key != count(explode(',', $blogg->tags)) - 1  ? ',':''}}</a>
                                    ...
                                    <aside class="sidebar-wrap w-100">
                                         <div class="widget-box w-100">
                                            ...
                                            <ul class="cate-list mb-0 list-unstyled w-100">
                                                ...
                                                <li><a href="{{ route('front.blogcategory',['slug' => $cat->slug ,'lang' => $sign ]) }}" title=""> @if($langg->rtl == 1)
                                                            {{ $cat->name_ar }}
                                                        @else
                                                            {{ $cat->name }}
                                              ...
                                              @foreach($rec_blogs as $k=>$blog)
                                                ...
                                                <div class="article-box d-flex flex-wrap w-100">
                                                    ...
                                                    <div class="article-info">
                                                        ...
                                                        <h4 class="mb-0"><a href="{{route('front.blogshow',['id' => $blog->slug ,'lang' => $sign ])}}" title="">
                                                                @if($langg->rtl == 1)
