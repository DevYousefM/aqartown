...
@section('content')
    ...
    <section>
                <div class="w-100 pt-180 pb-180 page-title-wrap text-center black-layer opc5 position-relative">
                    <div class="fixed-bg" style="background-image: url({{asset('assets/images/'.$gs->contact_icon)}});"></div>
                    <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6 col-lg-4">
                                    <div class="contact-info-box mb-40 w-100">
                                        ...
                                        <p class="mb-0"><span class="d-block">Phone: {{$ps->phone}}</span><span class="d-block">{{$ps->fax}}</span></p>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6 col-lg-4">
                                    <div class="contact-info-box mb-40 w-100">
