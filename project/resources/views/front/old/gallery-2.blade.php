                            ...
                            @foreach($galleries as $gallery)
                                <div class="col-md-6 col-sm-6 col-lg-4 fltr-itm">
                                    <div class="gallery-item2 text-center mb-30 w-100 positi    on-relative overflow-hidden">
                                        <img class="img-fluid w-100" style="width: 370px;height: 380px" src="{{asset('assets/images/banners/'.$gallery->photo)}}" alt="Portfolio Image 1">
                                        <div class="gallery-info2 position-absolute">
                                            <h4 class="mb-0">@if($langg->rtl == 1)
                                                    {{$gallery->title_ar}}
                                            ...
                                            <a href="{{asset('assets/images/banners/'.$gallery->photo)}}" data-fancybox="gallery" title=""><i class="flaticon-loupe"></i></a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
