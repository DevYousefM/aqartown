                            ...
                            @foreach($sliders as $slide)
                                ...
                                @if(!empty($slide->date))
                                    ...
                                    <div class="feat-item pb-240 d-flex flex-wrap align-items-end">
                                        <div class="feat-img position-absolute w-100" style="background-image: url({{asset('/assets/images/sliders/'.$galss)}})"></div>
                                        <div class="container">
                                            <div class="row justify-content-between align-items-end">
                                                @if(!empty($slide->video))
                                                <div class="col-md-12 col-sm-12 col-lg-5 order-lg-1">
                                                    <span class="d-block text-right">
                                                        <a class="d-inline-block play-btn" data-fancybox href="{{$slide->video}}" title="Video">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-lg-7">
                                                    <div class="feat-cap w-100" style="padding-left: 8%;">
                                                       @if(!empty($slide->subtitle_text) || !empty($slide->subtitle_text_ar) ) <i class="text-white">{{$langg->rtl == 1 ? $slide->subtitle_text_ar :   $slide->subtitle_text}}</i> @endif
                                                           @if(!empty($slide->title_text) || !empty($slide->title_text_ar) )   <h3 class="mb-0 text-white"><a href="{{$slide->link}}" title="">{{$langg->rtl == 1 ? $slide->title_text_ar :   $slide->title_text}}</a></h3>@endif
                                                           @if(!empty($slide->details_text) || !empty($slide->details_text_ar) )    <span class="d-block text-white"><i class="fas fa-map-marker-alt"></i>{{$langg->rtl == 1 ? $slide->details_text_ar :   $slide->details_text}}</span>@endif
                                                     <br>
                                                     <br>
                    		...
                    		<div class="row align-items-center">
                    			<div class="col-md-12 col-sm-12 col-lg-6">
                    				<div class="about-img style2">
                    					...
                    					<a class="d-inline-block position-absolute play-btn" data-fancybox href="{{$about_us->video}}" title="Video">
                                            <svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="10rem" width="10rem" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
                                                <path class="stroke-dotted" fill="none" stroke="#fff" d="M49.9,2.5C23.6,2.8,2.1,24.4,2.5,50.4C2.9,76.5,24.7,98,50.3,97.5c26.4-0.6,47.4-21.8,47.2-47.7 C97.3,23.7,75.7,2.3,49.9,2.5"></path> 
                                                <path class="icon" fill="#fff" d="M38,69c-1,0.5-1.8,0-1.8-1.1V32.1c0-1.1,0.8-1.6,1.8-1.1l34,18c1,0.5,1,1.4,0,1.9L38,69z"></path>
                                            </svg>
                    			...
                    			<div class="col-md-12 col-sm-12 col-lg-6">
                    				<div class="about-desc3 w-100">
				                        ...
				                        <p class="mb-0"> @if($langg->rtl == 1)
                                            ...
                                            @endif</p>
				                        <a class="thm-btn fill-btn" href="{{ route('front.about',$sign) }}" title="">More Information <i class="flaticon-trajectory"></i><span></span></a>
                    				</div>
                    			</div>
                    		</div>
                    		...
                    		<div class="features-inner w-100">
                                ...
                                @if(count($categoriesss) > 0)
                                    ...
                                    <div class="btns-wrap mt-60 text-center w-100">
                                        ...
                                        <button class="thm-btn mt-20 brd-btn read-more-btn"  id="myBtn"  title="">{{ $langg->lang12 }}<i class="flaticon-trajectory"></i><span></span></button>
                                    </div><!-- Buttons Wrap -->
                                </div>
                                    @endif
                    		</div>
                        ...
                        <div class="blog-wrap w-100">
                            <div class="blog-caro">
                                ...
                                <div class="post-style1 w-100 position-relative">
                                    <div class="post-meta">
                                        <span class="post-date thm-clr">{{date('d', strtotime($blogg->created_at))}}<i class="d-block">{{date('M, Y', strtotime($blogg->created_at))}}</i></span>
                                        <span class="post-cmt">{{ count($blogg->comments) }}</span>
                                    </div>
                                    <div class="post-img overflow-hidden position-relative w-100">
                                        <a href="{{route('front.blogshow',['id' => $blogg->slug ,'lang' => $sign ])}}" title=""><img class="img-fluid w-100" src="{{ $blogg->photo ? asset('assets/images/blogs/'.$blogg->photo):asset('assets/images/noimage.png') }}"
                                          alt="{{ $langg->rtl == 1 ? $blogg->alt_ar : $blogg->alt}}" ></a>
                                    </div>
                                    <div class="post-info w-100">
                                        <h3 class="mb-0"><a href="{{route('front.blogshow',['id' => $blogg->slug ,'lang' => $sign ])}}" title="">  @if($langg->rtl == 1)
                            ...
                            @foreach($counters as $counter)
                                <div class="col-md-6 col-sm-6 col-lg-4">
                                    <div class="fact-box mt-30 w-100">
                                        ...
                                        <a href="#" >
                                        <span class="d-block" style="font-size: 25px;letter-spacing: 3px;">{{$langg->rtl == 1 ? $counter->title_ar : $counter->title}} </span>
                                        </a>
                                    </div>
                                </div>
                           @endforeach
            ...
            <section>
                <div class="w-100 position-relative">
                    <div class="contact-map-wrap w-100">
                    	<h2 class="mb-0 text-center"><span class="thm-clr">{{ $langg->lang1 }}</span> {{ $langg->lang2 }} <br> {{ $langg->lang3 }} </h2>
	                    		...
	                    		<div class="col-md-6 col-sm-12 col-lg-6">
	                    			<div class="contact-form-wrap w-100">
	                    				<div class="contact-form-inner d-inline-block">
                                            <form class="w-100" id="email-form" action="{{route('front.contact.submit')}}" method="POST" >
                                                {{csrf_field()}}
                                                ...
                                                <div class="row mrg20">
                                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                                        <input class="w-100 fname" type="text" name="name" placeholder="{{ $langg->lang47 }} *" required>
                                                    </div>
                                                    {{-- <div class="col-md-6 col-sm-6 col-lg-6">
                                                         <input class="w-100 lname" type="text" name="lname" placeholder="Last Name" required>
                                                     </div>--}}
                                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                                        <input class="w-100 email" type="email" name="email" placeholder="{{ $langg->lang49 }} *" required>
                                                    </div>
                                                    <div class="col-md-12 col-sm-12 col-lg-12">
                                                        <input class="w-100 phone" type="tel" name="phone" placeholder="{{ $langg->lang48 }} *" required>
                                                    </div>
                                                    <div class="col-md-12 col-sm-12 col-lg-12">
                                                        ...
                                                        <button class="thm-btn fill-btn" id="submit" type="submit">{{ $langg->lang52 }}<span></span></button>
                                                    </div>
                                                </div>
                                            </form>
	                    				</div>
...
<!--sr-box -->
                        		...
                        		<div class="text-center w-100">
	                                <a href="{{$partner->link}}" title=""><img class="img-fluid d-inline-block" src="{{asset('assets/images/partner/'.$partner->photo)}}" alt="Sponsor Image 1"></a>
	                            </div>
	                        	@endforeach
                        	</div>
                        </div><!-- Sponsors Wrap -->
