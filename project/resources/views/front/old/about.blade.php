...
@section('content')
    ...
    <section>
                <div class="w-100 pt-180 pb-180 page-title-wrap text-center black-layer opc5 position-relative">
                    <div class="fixed-bg" style="background-image: url({{asset('assets/images/'.$gs->best_icon)}});"></div>
                    <div class="container">
    ...
    height: 345px;
">
                            <img src="{{asset('assets/images/services/'.$data->photo)}}" alt="" class="img-responsive" >
                            <figcaption>
                              <p> @if($langg->rtl == 1)
                                  ...
                                  @endif</p>
                              <ul>
                               @if(!empty($data->facebook )) <li><a href=" {!! $data->facebook !!}"><i style="
    color: wheat;
" class="fab fa-facebook-f"></i></a></li> @endif
                                   @if(!empty($data->twiter ))   <li><a href=" {!! $data->twiter !!}"><i style="
    color: wheat;
"class="fab fa-twitter"></i></a></li>@endif
                                   @if(!empty($data->linkedin ))  <li><a href=" {!! $data->linkedin !!}"><i style="
    color: wheat;
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-3 col-sm-6 col-lg-3">
                                    <div class=" text-center mb-30 w-100">
                                        <a href="javascript:void(0);" title=""><img class="img-fluid" src="{{asset('assets/images/ads/'.$data->photo)}}" alt="Sponsor Image 1"></a>
                                    </div>
                                </div>
                                @endforeach
                            </div>
