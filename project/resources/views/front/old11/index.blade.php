                            ...
                            <div class="single-solution-style1">
                                ...
                                <div class="text-holder">
                                    ...
                                    <div class="readmore">
                                        ...
                                        {{ route('front.category',['category' => $cat->slug_ar, 'subcategory' => $subcat->slug_ar , 'lang' => $sign]) }}

                                        @else
                                        {{ route('front.category',['category' => $cat->slug, 'subcategory' => $subcat->slug , 'lang' => $sign]) }}

                                        @endif"><span class="flaticon-next"></span></a>
                    ...
                    <div class="col-lg-6">
                        <div class="about-img">
                            <img src="{{asset('assets/images/'.$gs->home_about_img1)}}" alt="about image"
                                class="img-fluid">
                            <a href="{{$gs->home_about_link}}" title="Youtube Video"
                                data-autoplay="true" data-vbtype="video" class="video-btns  venobox vbox-item">
                        ...
                        <div class="news-block-one wow fadeInUp animated animated animated" data-wow-delay="00ms"
                            ...
                            <div class="inner-box">
                                <figure class="image-box">
                                    ...
                                    @endif" class="link"><i class="fal fa-link"></i></a>

                                </figure>
                                <div class="lower-content">
                                    <h3><a href="@if($langg->rtl == 1)
                                        {{ route('front.category',['category' => $cat->slug_ar, 'subcategory' => $subcat->slug_ar , 'lang' => $sign]) }}
                                        ...
                                        @endif">
                                            ...
                                            @else
                                                {{$subcat->name}}
                                            @endif                                        </a></h3>
                                    <div class="link"><a href="@if($langg->rtl == 1)
                                        {{ route('front.category',['category' => $cat->slug_ar, 'subcategory' => $subcat->slug_ar , 'lang' => $sign]) }}
                                    ...
                                    <div class="btn-box"><a href="@if($langg->rtl == 1)
                                        {{ route('front.category',['category' => $cat->slug_ar, 'subcategory' => $subcat->slug_ar , 'lang' => $sign]) }}

                                        @else
                                        {{ route('front.category',['category' => $cat->slug, 'subcategory' => $subcat->slug , 'lang' => $sign]) }}

                                        @endif" class="theme-btn-one">
                        ...
                        <div class="testimonial-carousel owl-carousel owl-theme">
                            ...
                            <div class="single-testimonial-item text-center">
                                <div class="text-holder">
                                    ...
                                    <div class="img-holder">
                                        <img src="{{ $review->photo ? asset('assets/images/reviews/'.$review->photo):asset('assets/images/noimage.png') }}" alt="Awesome Image">
                                    </div>
                                </div>
                                <div class="name">
