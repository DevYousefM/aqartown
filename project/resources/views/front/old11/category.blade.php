                        ...
                        <div class="inner-content clearfix">
                            ...
                            <div class="breadcrumb-menu float-left">
                                <ul class="clearfix">
                                    ...
                                    <li class="active">@if(!empty($childcat))
                                            @if($langg->rtl == 1)
                                                {{ $childcat->name_ar }}
                            ...
                            <div class="text-holder">
                                ...
                                <div class="readmore">
                                    ...
                                    <div class="overlay-button">
                                        <a href="{{ route('front.category',['category' => $subcat->category->slug_ar, 'subcategory' => $subcat->slug_ar , 'lang' => $sign]) }}">معرفه المزيد</a>
                                    </div>
                                </div>
                            </div>
                        </div>
