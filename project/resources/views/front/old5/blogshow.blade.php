                        ...
                        <div class="widget widget_grin_posts_thumb">
                            ...
                            <article class="item">
                                <a href="{{ route('front.blogshow',['id' => $blog->id ,'lang' => $sign ]) }}" class="thumb">
                                    <span class="fullimage cover bg1" role="img" style="background-image: url({{ asset('assets/images/blogs/'.$blog->photo) }});"></span>
                                </a>
                                <div class="info">
                                    <span>   {{ date('M d - Y',(strtotime($blog->created_at))) }}</span>
                                    <h4 class="title usmall">
                                        <a href="{{ route('front.blogshow',['id' => $blog->id ,'lang' => $sign ]) }}">  @if($langg->rtl == 1)
