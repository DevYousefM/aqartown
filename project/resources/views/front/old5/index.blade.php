...
@section('content') 
    ...
    @foreach($sliders as $slide)
                                        ...
                                        @endphp
        <div class="main-slides-item item-bg4" style="background-image: url({{asset('/assets/images/sliders/'.$galss)}});">
            <div class="container">
                <div class="main-slides-content">
                    ...
                    @if(!empty($slide->subtitle_text) || !empty($slide->subtitle_text_ar) )  
                       <h1> <span>{{$langg->rtl == 1 ? $slide->subtitle_text_ar :   $slide->subtitle_text}}</span> </h1>
                       @endif   
                    <p>{{$langg->rtl == 1 ? $slide->title_text_ar :   $slide->title_text}}</p>
                    @if(!empty($slide->btn_text) || !empty($slide->btn_text_ar) ) 
                    <div class="slides-btn">
                        <a href="{{$slide->link}}" class="default-btn">{{$langg->rtl == 1 ? $slide->btn_text_ar :   $slide->btn_text}}</a>
                ...
                <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                    <div class="single-features bg-4a6577">
                        <div class="content">
                            ...
                            <span class="cmsmasters_homepage_fb_opening_item" style="color: #ffffff;">{{ $title[$key] }}
    ...
    <section class="section_padding about_us_area" data-scroll-index="1">
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="about_bg" style="background-image: url({{asset('assets/images/'.$gs->home_about_img1)}});"></div>
                </div>
            </div>
        </div>
    </section>
