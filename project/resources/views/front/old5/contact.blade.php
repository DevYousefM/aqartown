...
@php 
  ...
  $ps = App\Models\Pagesetting::find(1);
   ...
   @endphp
    ...
    <div class="page-banner-area" style="background-image: url({{asset('assets/images/'.$gs->discount_icon)}});">
        <div class="container">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                <input type="text" name="phone" id="phone_number" required
                                    data-error="Please enter your number" class="form-control email" placeholder="{{ $langg->lang48 }}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
...
<!-- 
                        ...
                        <li> <a target="_blank" href="{{ App\Models\Socialsetting::find(1)->facebook }}"
                                            ...
                                            <li>  <a target="_blank" href="{{ App\Models\Socialsetting::find(1)->instagram }}">  <i class='bx bxl-instagram'></i></a></li>
                                                @endif 
