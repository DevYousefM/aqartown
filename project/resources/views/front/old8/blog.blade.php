                        ...
                        <div class="news-block-one wow fadeInUp animated animated animated" data-wow-delay="00ms"
                            ...
                            <div class="inner-box">
                                <figure class="image-box">
                                    ...
                                    <a href="{{route('front.blogshow',['id' => $blogg->slug ,'lang' => $sign ])}}" class="link"><i class="fal fa-link"></i></a>
                                ...
                                <div class="lower-content">
                                    ...
                                    <div class="link"><a href="{{route('front.blogshow',['id' => $blogg->slug ,'lang' => $sign ])}}"><i class="far fa-long-arrow-right"></i></a>
                                    </div>
                                    <div class="btn-box"><a href="{{route('front.blogshow',['id' => $blogg->slug ,'lang' => $sign ])}}" class="theme-btn-one">View details <i
