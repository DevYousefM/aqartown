...
@php 
  ...
  $ps = App\Models\Pagesetting::find(1);
   ...
   @endphp
         <section class="medicen-aboutUs text-center" style="background-image: url({{asset('assets/images/'.$gs->best_icon)}});">
...
<h4 class = "mb-0"> العلاج الطبي والجراحي </ h4>
        ...
        <section>
            <div class="w-100 gray-layer opc95 pb-10 position-relative">
                <div class="fixed-bg" style="background-image: url({{asset('assets/images/'.$gs->about_page_background)}});opacity: .4;"></div>
                <div class="container">
                            ...
                            <div class="col-md-12 col-sm-12 col-lg-6 order-lg-1">
                                <div class="about-gal w-100">
                                    ...
                                    <div class="row mrg20">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                            <div class="about-gal-img brd-rd10 overflow-hidden position-relative w-100">
                                                <a class="about-play-btn spinner thm-clr rounded-circle" href="{{$gs->home_about_link}}" data-fancybox title=""><i class="fas fa-play-circle"></i></a>
