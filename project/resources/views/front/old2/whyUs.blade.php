...
@php 
  ...
  $ps = App\Models\Pagesetting::find(1);
   ...
   @endphp
        <section class="medicen-aboutUs text-center" style="background-image: url({{asset('assets/images/'.$gs->new_icon)}});">
                        ...
                        @foreach($title as $key => $data1)
                            <div class="col-12 col-md-6">
                                <div class="professional-box">
                                    <h2 class="d-flex align-items-center">{{$langg->rtl == 1 ? $title_ar[$key] : $title[$key]}}</h2>
