...
@section('content')
        <section class="medicen-aboutUs text-center" style="background-image: url({{asset('assets/images/'.$gs->discount_icon)}});">
             ...
             <div class="row">
              ...
              <div class="form-section">
                ...
                {{ $langg->lang8 }}
                  ...
                  <form  action="{{route('front.contact.submit')}}" name="appointment" id="email-form" method="POST" autocomplete="off">
...
<input type="hidden" name="to" value="{{ $ps->contact_email }}">
        <div class="col-md-12">
            <div class="btn-box text-center"><button class="thm-btn v2 thm-bg brd-rd5 position-relative overflow-hidden" type="submit">{{ $langg->lang52 }}</button></div>
