...
@section('content')
            <section class="medicen-aboutUs text-center" style="background-image: url({{asset('assets/images/'.$gs->top_icon)}});">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="service_details_wraper" style="margin-right: 50px;padding-top: 50px;">
                            ...
                            <div class="text-p">
                                <h2 class=" sub-title" style="font-weight: 900;font-size: 20px;"><i class="fab fa-slack"></i>  @if(!empty($childcat))
                        @if($langg->rtl == 1)
                             {{ $childcat->name_ar }}
