                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="breadcrumbs-wrap">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page">@if($type == 'product')
{{$langg->lang223}} 
@else
{{$langg->lang20}} 
@endif</li>
                            </ol>
                           <h2 class="breadcrumb-title">@if($type == 'product')
{{$langg->lang223}} 
@else
{{$langg->lang20}} 
@endif -<span onclick="window.location.href='{{route('front.index',$sign)}}'"
