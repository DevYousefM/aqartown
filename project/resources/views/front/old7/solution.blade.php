...
@php 
  ...
  $ps = App\Models\Pagesetting::find(1);
   ...
   @endphp
			<!-- ============================ Page Title Start================================== -->
			<div class="page-title" style="background:linear-gradient(#21459799, #21459799), url({{asset('assets/images/'.$gs->big_icon)}});" data-overlay="5">
				<div class="container">
					<div class="row">
                        ...
                        <article class="post p-relative">
                          <div class="post-wrapper">
                            ...
                            <div class="blog-meta bg-custom-white">
                              ...
                              <div class="post-heading p-relative" style="
                              padding: 20px 0;
                          ">
                                <h2><a href="#" class="text-custom-black">@if($langg->rtl == 1)
...
@endif
                              ...
                              <div class="quote-box mb-xl-20">
                                <blockquote class="bg-light-white"> <span> <i class="fa fa-quote-left text-custom-white"></i> </span>
                                  ...
                                  <p class="text-custom-black fs-16 no-margin">@if($langg->rtl == 1)
...
@endif </p>
                    ...
                    <div class="row">
                        <div class="col">
                            <img style="width: 100%;" src="{{asset('assets/images/products/'.$solution->hover_photo)}}" alt="">
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <a href="@if($langg->rtl == 1)
                          ...
                          @endif​​
                                ...
                                <h5 class="brand-title text-center black p-2">@if($langg->rtl == 1)
        ...
        <div class="services-section">
            ...
            <div class="section-body">
                ...
                @forelse($about_uss as $k=> $about_us)
                    ...
                    <li>
                        <a href=" {{ route('front.product2',['slug' => $about_us->slug, 'lang' => $sign]) }}" class="main-flip-card">
