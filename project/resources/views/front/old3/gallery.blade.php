            ...
            <div class="filter-btns col">
                <ul class="isotope_menu">
                    ...
                    @foreach($galleries as $key=>$data)  
                         <button type="button" data-mixitup-control data-filter=".a{{$data->id}}"> @if($langg->rtl == 1)
        ...
        <div class="img-container">
            ...
            @foreach($images as $key=>$data)   
                        <div class="col-md-4 mix a{{$data->country_id}}">
                            <a href="{{asset('assets/images/gallery/'.$data->photo)}}" class="img_popup single_gallery ">
                                <div class="gallery_img" style="background-image: url({{asset('assets/images/gallery/'.$data->photo)}});">
