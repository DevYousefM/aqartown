 ...
 <secion class="price-packages weight-lifing-outline-bg pt-4 pb-5">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <img src="{{asset('assets/images/speakers/'.$offer->photo)}}" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <div class="brdr" style="background-color: #000;width: 100%;height: 0.3px;margin-top: 10px;margin-bottom: 10px;">
                        </div>
