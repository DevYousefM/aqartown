    ...
    @if (Session::has('cart'))
        <div>
            <div class="dropdown-cart-header">
                <span id="cart-count" class="cart-quantity"> {{ count(Session::get('cart')->items) }} </span>
                &nbsp;&nbsp;&nbsp; Items
                ...
                @foreach (Session::get('cart')->items as $product)
                    <div
                        ...
                        <figure class="product-image-container">
                            ...
                            <a class="cart-remove btn-remove icon-cancel"
            ...
            <div class="dropdown-cart-total">
                ...
                <span
                    class="cart-total-price cart-total">{{ Session::has('cart') ? App\Models\Product::convertPrice(Session::get('cart')->totalPrice) : '0.00' }}</span>
