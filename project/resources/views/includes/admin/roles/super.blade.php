...
<!---->
 ...
 <li class="@if(request()->is('admin/attribute/*/manage') && request()->input('type')=='services') active @endif">
     <a href="{{ route('admin-cat2-index') }}"><span><i class="fas fa-fw fa-newspaper"></i>{{ __('services') }}</span></a>
 </li>
     <!---->
 <li>
     <a href="{{ route('admin-blog-index') }}"><span><i class="fas fa-fw fa-newspaper"></i>{{ __('Blogs') }}</span></a>
 </li>
