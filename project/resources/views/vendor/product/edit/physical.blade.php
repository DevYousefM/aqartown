...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading"> EDIT <a class="add-btn" href="{{ route('vendor-prod-index',['lang' => $sign ]) }}"><i class="fas fa-arrow-left"></i> {{ $langg->lang550 }}</a></h4>
											<ul class="links">
                      <li>
                        ...
                        @include('includes.vendor.form-both')
                                                ...
                                                <div>
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __('Enter  Name') }}" name="name" required="" value="{{ $data->name }}">
													</div>
												</div>
												<div class="row">
													<div class="col-lg-4">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __('Enter  Arabic Name') }}" name="name_ar" required="" value="{{ $data->name_ar }}">
													</div>
												</div>
													<div class="row">
														<div class="col-lg-4">
														...
														<div class="col-lg-7">
															<input type="text" class="input-field" placeholder="{{ __('Enter   title') }}" name="title" value="{{ $data->title}}">
														</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-lg-7">
															<input type="text" class="input-field" placeholder="{{ __('Enter  Arabic title') }}" name="title_ar" value="{{ $data->title_ar }}">
														</div>
													</div>
														...
														<div class="col-lg-7">
															<select id="cat" name="location_id" required="">
																...
																@foreach($locations as $location)
																	<option  value="{{ $location->id }}" {{$location->id == $data->location_id ? "selected":"" }}>{{$location->country_name}}</option>
																@endforeach
															</select>
														</div>
													</div>	<div class="row">
														...
														<div class="col-lg-7">
															<select id="cat" name="range_id" required="">
																...
																@foreach($works as $work)
																	<option  value="{{ $work->id }}" {{$work->id == $data->range_id ? "selected":"" }}>{{$work->name}}</option>
																@endforeach
															</select>
														</div>
													</div>
														...
														<div class="row">
															...
															<div class="col-lg-7">
																<select name="product_condition">
																	<option value="2" {{$data->product_condition == 2 ? "selected":""}}>{{ __('rent') }}</option>
																	<option value="1" {{$data->product_condition == 1 ? "selected":""}}>{{ __('sell') }}</option>
																</select>
															</div>
														</div>
													</div>
                                           ...
                                           <div class="row">
												...
												<div class="row">
													...
													<div class="row">
														...
														<div class="col-lg-7">
															<input name="price" type="text" class="input-field" placeholder=""  value="{{$data->price}}">
														</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-lg-7">
															<input name="parking" type="text" class="input-field" placeholder="" value="{{$data->parking}}">
														</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-lg-7">
															<input name="open_time" type="text" class="input-field" placeholder="" value="{{$data->open_time}}">
														</div>
													</div>
													<div class="row">
														<div class="col-lg-4">
														...
														<div class="col-lg-7">
															<input name="price_from"  type="text" class="input-field" placeholder="" value="{{$data->price_from}}">
														</div>
													</div>
													<div class="row">
														<div class="col-lg-4">
														...
														<div class="col-lg-7">
															<input name="time" type="text" class="input-field" placeholder="" value="{{$data->time}}">
														</div>
													</div>
												{{--	<div class="row">
														<div class="col-lg-4">
													...
													<div class="row">
														...
														<div class="col-lg-7">
															<input name="location" type="text" class="input-field" placeholder="" value="{{$data->location}}">
														</div>
													</div>
													<div class="row">
														<div class="col-lg-4">
														...
														<div class="col-lg-7">
															<input name="reg_link" type="text" class="input-field" placeholder="" value="{{$data->reg_link}}">
														</div>
													</div>
													<div class="row">
														<div class="col-lg-4">
														...
														<div class="col-lg-7">
															<input name="touch" type="text" class="input-field" placeholder="" value="{{$data->touch}}">
														</div>
													</div>
													<!--
                                                     -->
...
$('.cropme').click();
  ...
  $(document).ready(function() {
    ...
    let html = `<img src="{{ !empty($data->photo) ?  filter_var($data->photo, FILTER_VALIDATE_URL) ? $data->photo : asset('assets/images/products/'.$data->photo) : asset('assets/images/noimage.png') }}" alt="">`;
