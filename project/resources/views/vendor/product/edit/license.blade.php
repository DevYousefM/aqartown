...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading"> {{ $langg->lang704 }} <a class="add-btn" href="{{ route('vendor-prod-index') }}"><i
                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('vendor-prod-update', $data->id) }}" method="POST"
                                    ...
                                    <div class="col-lg-7">
                                        <select id="type_check" name="type_check">
                                            <option value="1" {{ $data->file != null ? 'selected' : '' }}>
                                                {{ $langg->lang693 }}</option>
                                            <option value="2" {{ $data->link != null ? 'selected' : '' }}>
                                                {{ $langg->lang694 }}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row link {{ $data->link != null ? '' : 'hidden' }}">
                                    ...
                                    <div class="col-lg-7">
                                        <textarea class="input-field" rows="4" name="link" placeholder="{{ $langg->lang696 }}"
