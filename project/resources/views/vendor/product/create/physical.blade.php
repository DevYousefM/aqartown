...
@endphp
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading">{{ $langg->lang518 }} <a class="add-btn" href="{{ route('vendor-prod-index',['lang' => $sign ]) }}"><i class="fas fa-arrow-left"></i> {{ $langg->lang550 }}</a></h4>
											<ul class="links">
                      <li>
                      ...
                      <li>
                        <a href="{{ route('vendor-prod-index',['lang' => $sign ]) }}">{{ $langg->lang443 }}</a>
												...
												<li>
													<a href="{{ route('vendor-prod-physical-create',['lang' => $sign ]) }}">{{ $langg->lang518 }}</a>
												</li>
											</ul>
									</div>
								</div>
                        ...
                        @include('includes.vendor.form-both')
                                            	...
                                            	<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __('Enter  Name') }}" name="name" required="">
													</div>
												</div>
												<div class="row">
													<div class="col-lg-4">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __('Enter  Arabic Name') }}" name="name_ar" required="">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __('Enter   title') }}" name="title" >
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __('Enter  Arabic title') }}" name="title_ar" >
													</div>
												</div>
													...
													<div class="col-lg-7">
															<select id="cat" name="category_id" required="">
																	<option value="">{{ __('Select Category') }}</option>
						                                              @foreach($cats as $cat)
						                                                  <option data-href="{{ route('vendor-subcat-load',$cat->id) }}?lang={{$langg->rtl}}" value="{{ $cat->id }}">{{ $langg->rtl == 1 ? $cat->name_ar :  $cat->name}}</option>
						                                              @endforeach
						                                     </select>
													</div>
												</div>
                            ...
                            <span class='span-img-size'>Image size 1170px X 520px</span>
												...
												<div class="row">
													...
													<div class="row">
														...
														<div class="col-lg-7">
															<input name="price" type="text" class="input-field" placeholder=""  value="">
														</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-lg-7">
															<input name="parking" type="text" class="input-field" placeholder="" value="">
														</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-lg-7">
															<input name="open_time" type="text" class="input-field" placeholder="" value="">
														</div>
													</div>
													<div class="row">
														<div class="col-lg-4">
														...
														<div class="col-lg-7">
															<input name="price_from"  type="text" class="input-field" placeholder="" value="">
														</div>
													</div>
													<div class="row">
														<div class="col-lg-4">
														...
														<div class="col-lg-7">
															<input name="time" type="text" class="input-field" placeholder="" value="">
														</div>
													</div>
													{{--	<div class="row">
                                                            <div class="col-lg-4">
													...
													<div class="row">
														...
														<div class="col-lg-7">
															<input name="location" type="text" class="input-field" placeholder="" value="">
														</div>
													</div>
													<div class="row">
														<div class="col-lg-4">
														...
														<div class="col-lg-7">
															<input name="reg_link" type="text" class="input-field" placeholder="" value="">
														</div>
													</div>
													<div class="row">
														<div class="col-lg-4">
														...
														<div class="col-lg-7">
															<input name="touch" type="text" class="input-field" placeholder="" value="">
														</div>
													</div>
